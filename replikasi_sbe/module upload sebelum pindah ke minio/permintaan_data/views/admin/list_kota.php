  <div class="row">
                                                        <?php foreach ($data_file_permintaan as $k => $v_wilayah) { ?>
                                                        <div class="col-md-4">
                                        ...
                                        <div class="card-header">
                                            Wilayah <?php echo $k ?>
                                                                ...
                                                                <ul class="list-group list-group-flush">
                                                                    <?php foreach ($v_wilayah as $k_instansi => $v_instansi) { ?>
                                                                    <li class="list-group-item">
                                                                        <div class="widget-content p-0">
                                                                            <div class="widget-content-wrapper">
                                                                                <div class="widget-content-left">
                                                                                    <div class="widget-heading"><?php echo $v_instansi['nama_kota'] ?></div>
                                                        ...
                                                        <?php } ?>
                                                                <a href="<?php echo base_url('permintaan_data/print_kab_kota/'.sbe_crypt($id_permintaan_data)) ?>" class="btn btn-block btn-info btn-sm" target="_blank">Print</a>
                                                    </div>