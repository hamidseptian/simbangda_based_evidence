...
<div style="width:33.33%; float:left">
  <table class="font_laporan laporan_asisten table">
    <thead class="tabel_header">      
      ...
      <?php 
        if (count($data_file_permintaan['asisten_1_sudah'])==0) { ?>
            <tr>
                <td colspan="3">Belum ada data</td>
            </tr>
        <?php }else{
          foreach ($data_file_permintaan['asisten_1_sudah'] as $k => $v) { ?>
            <tr>
                <td align="center"><?php echo $k+1 ?></td>
                <td align=""><?php echo $v['nama_instansi'] ?></td>
...
<div style="width:33.33%; float:left">
  <table class="font_laporan laporan_asisten table">
    <thead class="tabel_header">      
      ...
      <?php 
        if (count($data_file_permintaan['asisten_2_sudah'])==0) { ?>
            <tr>
                <td colspan="3">Belum ada data</td>
            </tr>
        <?php }else{
          foreach ($data_file_permintaan['asisten_2_sudah'] as $k => $v) { ?>
            <tr>
                <td align="center"><?php echo $k+1 ?></td>
                <td align=""><?php echo $v['nama_instansi'] ?></td>
                <td align=""><?php echo $v['waktu_upload'] ?></td>
...
<div style="width:33.33%; float:left">
  <table class="font_laporan laporan_asisten table">
    <thead class="tabel_header">      
      ...
      <?php 
        if (count($data_file_permintaan['asisten_3_sudah'])==0) { ?>
            <tr>
                <td colspan="3">Belum ada data</td>
            </tr>
        <?php }else{
          foreach ($data_file_permintaan['asisten_3_sudah'] as $k => $v) { ?>
            <tr>
                <td align="center"><?php echo $k+1 ?></td>
                <td align=""><?php echo $v['nama_instansi'] ?></td>
                <td align=""><?php echo $v['waktu_upload'] ?></td>
...
<div style="width:33.33%; float:left">
  <table class="font_laporan laporan_asisten table">
    <thead class="tabel_header">      
      ...
      <?php 
        if (count($data_file_permintaan['asisten_1_belum'])==0) { ?>
            <tr>
                <td colspan="2">Semua OPD lingkup Asisten Pemerintahan dan Kesejahteraan Rakyat mengirimkan Semua</td>
            </tr>
        <?php }else{
          foreach ($data_file_permintaan['asisten_1_belum'] as $k => $v) { ?>
            <tr>
                <td align="center"><?php echo $k+1 ?></td>
                <td align=""><?php echo $v['nama_instansi'] ?></td>
...
<div style="width:33.33%; float:left">
  <table class="font_laporan laporan_asisten table">
    <thead class="tabel_header">      
      ...
      <?php 
        if (count($data_file_permintaan['asisten_2_belum'])==0) { ?>
            <tr>
                <td colspan="2">Semua OPD lingkup Asisten Perekonomian Dan Pembangunan mengirimkan Semua</td>
            </tr>
        <?php }else{
          foreach ($data_file_permintaan['asisten_2_belum'] as $k => $v) { ?>
            <tr>
                <td align="center"><?php echo $k+1 ?></td>
                <td align=""><?php echo $v['nama_instansi'] ?></td>
...
<div style="width:33.33%; float:left">
  <table class="font_laporan laporan_asisten table">
    <thead class="tabel_header">      
      ...
      <?php 
        if (count($data_file_permintaan['asisten_3_belum'])==0) { ?>
            <tr>
                <td colspan="2">Semua OPD lingkup Asisten Administrasi Umum mengirimkan Semua</td>
            </tr>
        <?php }else{
          foreach ($data_file_permintaan['asisten_3_belum'] as $k => $v) { ?>
            <tr>
                <td align="center"><?php echo $k+1 ?></td>
                <td align=""><?php echo $v['nama_instansi'] ?></td>
