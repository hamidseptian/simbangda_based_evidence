        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" class="form-control" id="id_kota" name="id_kota" value="<?php echo $id_kota ?>">
                        <input type="hidden" class="form-control" id="id_permintaan_data" name="id_permintaan_data"  value="<?php echo $id_permintaan_data ?>">
                        <input type="hidden" class="form-control" id="nama_kota" name="nama_kota"  value="<?php echo $nama_kota ?>">
