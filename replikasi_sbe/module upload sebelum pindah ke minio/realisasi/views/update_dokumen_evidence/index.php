                ...
                <form id="form-update-evidence">
                    <div class="form-row">
                        ...
                        <div class="col-md-8">
                            ...
                            <input type="text" class="form-control" id="nama_kegiatan" name="nama_kegiatan" readonly="true" value="<?php echo $r_fisik->nama_sub_kegiatan; ?>">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-md-8">
                ...
                <?php } ?>
                    ...
                    <div class="form-row">
                        <div class="col-md-6" style="display:none">
                            <label for="filelama"><strong>File Lama</strong></label>
                        ...
                        <div class="col-md-6">
                            <label for=""><strong><?php 
                             $pecah=explode('___', $r_fisik->dokumen); 
                             echo $pecah[0];
                            ?></strong></label>
