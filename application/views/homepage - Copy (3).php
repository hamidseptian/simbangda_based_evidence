     ...
     <div class="app-header header-shadow">
        ...
        <div class="app-header__mobile-menu">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" aria-haspopup="true" aria-expanded="false" data-toggle="dropdown" class="mb-2 mr-2" style="border:none;background:none"><span class="hamburger-box">
                        ...
                        <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu-rounded dropdown-menu-lg rm-pointers dropdown-menu">
                            <div class="dropdown-menu-header">
                                <div class="dropdown-menu-header-inner bg-success">
                                    <div class="menu-header-image opacity-1" style="background-image: url('<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/images/dropdown-header/abstract3.jpg');"></div>
                        ...
                        <div class="widget-content p-0">
                            <div class="widget-content-wrapper">
                                <div class="widget-content-left">
                                        ...
                                        <div tabindex="-1" role="menu" aria-hidden="true" class="rm-pointers dropdown-menu-lg dropdown-menu dropdown-menu-right">
                                            <div class="dropdown-menu-header">
                                                <div class="dropdown-menu-header-inner bg-info">
                                                    <div class="menu-header-image opacity-2" style="background-image: url('<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/images/dropdown-header/city3.jpg');"></div>
                                                    <div class="menu-header-content text-left">
                                                        <div class="widget-content p-0">
                                                            <div class="widget-content-wrapper">
                                                                ...
                                                                <div class="widget-content-left">
                                                                    <div class="widget-heading"><?php echo $this->session->userdata('full_name'); ?>
                                                                    </div>
                                                                    <div class="widget-subheading opacity-8"><?php echo $this->session->userdata('group_name'); ?>
                                                                    </div>
                                                                    <div class="widget-subheading opacity-8"><?php echo $this->session->userdata('nama_instansi'); ?>
                                                                    </div>
                                                                </div>
                                            ...
                                            <div class="scroll-area-xs" style="height: 150px;">
                                                <div class="scrollbar-container ps">
                                                    <ul class="nav flex-column">
                                                        ...
                                                        <li class="nav-item">
                                                            <a href="<?php echo base_url() ?>dashboard" class="nav-link">Ke Halaman User [<?php echo $this->session->userdata('group_name') ?>]
                                                            </a>
                                                        </li>
                                                        <li class="nav-item-header nav-item"> <a href="<?php echo base_url('auth/logout') ?>" class="btn-shadow btn btn-focus">Logout</a>
                                   ...
                                   <a href="<?php echo  base_url() ?>auth" class="btn-shadow btn btn-info ">
                                    <i class="fa text-white fa-user pr-1 pl-1"></i> <b>  Login</b>
                                </a>
                            </div>
                                        <?php }else{ ?>
        ...
        <div class="col-lg-12 col-xl-12">
            <div class="main-card mt-3 card">
                ...
                <div class="btn-group btn-block">
                       <button type="button" class="btn-icon btn-shadow btn-outline-2x btn btn-outline-primary" onclick="grafik('Akumulasi')"><i class="fa fa-signal"> </i> Grafik Akumulasi</button>
                       <button type="button" class="btn-icon btn-shadow btn-outline-2x btn btn-outline-primary"  onclick="grafik('Bulanan')"><i class="fa fa-signal"> </i> Grafik Bulanan</button>
                       <button type="button" class="btn-icon btn-shadow btn-outline-2x btn btn-outline-primary"  onclick="data_per_opd()"><i class="fa fa-building"> </i> Lihat Per OPD</button>
        ...
        <div class="col-lg-3 col-xl-3">
            <div class="main-card mb-3 card ">
                <div class="card-body border border-secondary">
                   <div class="row">
                       <div class="col-md-4"><img src="<?php echo base_url('assets/logo_kab_kota/'.$v->logo) ?>" width="100%" height="130px"></div>
                       <div class="col-md-8">
                           ...
                           <table class="table">
                               ...
                               <tr>
                                   ...
                                   <td>:</td>
                                   <td><?php echo number_format($nilai_rk_kota_total) ?> <br>[<?php echo round($show_persen_rk_total,2) ?>%]</td>
                               </tr>
                               <tr>
...
?>
        <div class="col-lg-3 col-xl-3">
            <div class="main-card mb-3 card ">
                <div class="card-body border border-secondary">
                   <div class="row">
                       <div class="col-md-4"><img src="<?php echo base_url('assets/sbe/image/logo.png') ?>" width="100%" height="130px"></div>
                       <div class="col-md-8">
                           ...
                           <table class="table">
                               ...
                               <tr>
                                   <td>Realisasi Keuangan</td>
                                   <td>:</td>
                                   <td><?php echo number_format($total_rk_semuanya) ?> <br>[<?php echo round($show_persen_rk_semuanya,2); ?>%]</td>
                               </tr>
                               <tr>
                                   <td>Realisasi Fisik</td>
                                   <td>:</td>
              ...
              <div class="row">
                <div class="col-lg-3 col-md-6 mb-5">
                  <a href="index.html" class="navbar-brand">
                      ...
                      <img class="img-fluid" src="https://biroadmpembangunan.sumbarprov.go.id/assets/gambar/logo_biro.png" alt="">
                  </a> <br><br>
                  <audio src="https://biroadmpembangunan.sumbarprov.go.id/assets/music/marssumbar.mp3"></audio>

                  <p>Jl. Jend. Sudirman No.51, Padang Pasir, Kec. Padang Barat, Kota Padang, Sumatera Barat 25129</p>
                  <div class="d-flex justify-content-start mt-4">
                   <a class="btn btn-outline-secondary text-center mr-2 px-0" style="width: 38px; height: 38px;" href="https://biroadmpembangunan.sumbarprov.go.id/" target="_blank"><i class="fa fa-globe"></i></a>
                   <a class="btn btn-outline-secondary text-center mr-2 px-0" style="width: 38px; height: 38px;" href="https://www.facebook.com/biroadmpembangunan.sumbarprov" target="_blank"><i class="fab fa-facebook-f"></i></a>
                   <a class="btn btn-outline-secondary text-center mr-2 px-0" style="width: 38px; height: 38px;" href="mailto:biroadmpembangunan.sumbarprov@gmail.com" target="_blank"><i class="fa fa-envelope"></i></a>
                   <a class="btn btn-outline-secondary text-center mr-2 px-0" style="width: 38px; height: 38px;" href="https://www.instagram.com/biroadpemb_prov.sumbar/" target="_blank"><i class="fab fa-instagram"></i></a>
                   <a class="btn btn-outline-secondary text-center mr-2 px-0" style="width: 38px; height: 38px;" href="#" target="_blank"><i class="fab fa-youtube"></i></a>
               </div>
           </div>

           <div class="col-lg-3 col-md-6 mb-5">
             <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3989.2840949598635!2d100.35777017560198!3d-0.9376228353457584!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2fd4b950c9c87f35%3A0x203f97613e262574!2sBiro%20Administrasi%20Pembangunan!5e0!3m2!1sid!2sid!4v1713859623223!5m2!1sid!2sid" width="100%" height="250" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
         </div>
         <div class="col-lg-3 col-md-6 mb-5">
...
<div class="no-gutters row">
    <div class="col-sm-6">
        <button class="btn-icon-vertical btn-transition-text btn-transition btn-transition-alt pt-2 pb-2 btn btn-outline-dark"><i class="text-dark opacity-7 btn-icon-wrapper mb-2"> <?php echo  $pengunjungonline ?></i>User Online
        </button>
    </div>
    <div class="col-sm-6">
        <button class="btn-icon-vertical btn-transition-text btn-transition btn-transition-alt pt-2 pb-2 btn btn-outline-danger"><i class="text-danger opacity-7 btn-icon-wrapper mb-2"> <?php echo  $pengunjunglogin ?>  </i>User Login
        </button>
    </div>
    <div class="col-sm-6">
        <button class="btn-icon-vertical btn-transition-text btn-transition btn-transition-alt pt-2 pb-2 btn btn-outline-success"><i class="text-success opacity-7 btn-icon-wrapper mb-2"> <?php echo  $pengunjunghariini ?>  </i>Today
        </button>
    </div>
    <div class="col-sm-6">
        <button class="btn-icon-vertical btn-transition-text btn-transition btn-transition-alt pt-2 pb-2 btn btn-outline-focus"><i class="text-focus opacity-7 btn-icon-wrapper mb-2"> <?php echo  $totalpengunjung ?>  </i>All User 
        </button>
    </div>
</div>
...
<div class="col-lg-3 col-md-6 mb-5">
    <h4 class="font-weight-bold mb-4">Link Terkait</h4>
    <div class="d-flex flex-column justify-content-start">
      <a class="text-secondary mb-2" target="_blank" href="https://biroadmpembangunan.sumbarprov.go.id/"><i class="fa fa-angle-right text-dark mr-2"></i>Biro Administrasi Pembangunan <br>Sekretariat Daerah Provinsi Sumatera Barat</a>
      <a class="text-secondary mb-2" target="_blank" href="https://dashboard.sumbarprov.go.id/"><i class="fa fa-angle-right text-dark mr-2"></i>Dashboard Pembangunan</a>
      <a class="text-secondary mb-2" target="_blank" href="https://sumbarprov.go.id/"><i class="fa fa-angle-right text-dark mr-2"></i>Sumbarprov.go.id</a>
      <a class="text-secondary mb-2" target="_blank" href="https://ppid.sumbarprov.go.id/"><i class="fa fa-angle-right text-dark mr-2"></i>PPID Sumbar</a>
  </div>
</div>
</div>
</div>
        ...
        <div class="app-footer__inner">
            <div class="app-footer-left">
                <div class="footer-dots">
                 ...
                 <b style="margin-right:5px">Biro Administrasi Pembangunan</b> Sekretariat Daerah Provinsi Sumatera Barat
                 <div class="dots-separator"></div>
                        ...
                        <div class="d-none popover-custom-content">
                            <div class="dropdown-menu-header">
                                <div class="dropdown-menu-header-inner bg-tempting-azure">
                                    <div class="menu-header-image opacity-1" style="background-image: url('<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/images/dropdown-header/city5.jpg');"></div>
                                    <div class="menu-header-content text-dark"><h5 class="menu-header-title">Statistika User</h5></div>
                                </div>
                            </div>
                            <div class="grid-menu grid-menu-2col">
...
<!--Apex Charts-->
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/vendors/charts/apex-charts.js"></script>

<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/scripts-init/charts/apex-charts.js"></script>
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/scripts-init/charts/apex-series.js"></script>

<!--Sparklines-->
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/vendors/charts/charts-sparklines.js"></script>
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/scripts-init/charts/charts-sparklines.js"></script>

<!--Chart.js-->
<script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.4.0/Chart.min.js"></script>
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/scripts-init/charts/chartsjs-utils.js"></script>
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/scripts-init/charts/chartjs.js"></script>

<!--FORMS-->

<!--Clipboard-->
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/vendors/form-components/clipboard.js"></script>
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/scripts-init/form-components/clipboard.js"></script>

<!--Datepickers-->
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/vendors/form-components/datepicker.js"></script>
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/vendors/form-components/daterangepicker.js"></script>
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/vendors/form-components/moment.js"></script>
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/scripts-init/form-components/datepicker.js"></script>

<!--Multiselect-->
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/vendors/form-components/bootstrap-multiselect.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.6-rc.0/js/select2.min.js"></script>
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/scripts-init/form-components/input-select.js"></script>

<!--Form Validation-->
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/vendors/form-components/form-validation.js"></script>
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/scripts-init/form-components/form-validation.js"></script>

<!--Form Wizard-->
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/vendors/form-components/form-wizard.js"></script>
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/scripts-init/form-components/form-wizard.js"></script>

<!--Input Mask-->
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/vendors/form-components/input-mask.js"></script>
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/scripts-init/form-components/input-mask.js"></script>

<!--RangeSlider-->
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/vendors/form-components/wnumb.js"></script>
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/vendors/form-components/range-slider.js"></script>
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/scripts-init/form-components/range-slider.js"></script>

<!--Textarea Autosize-->
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/vendors/form-components/textarea-autosize.js"></script>
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/scripts-init/form-components/textarea-autosize.js"></script>

<!--Toggle Switch -->
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/vendors/form-components/toggle-switch.js"></script>
...
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/scripts-init/blockui.js"></script>

<!--Calendar -->
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/vendors/calendar.js"></script>
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/scripts-init/calendar.js"></script>

<!--Slick Carousel -->
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/vendors/carousel-slider.js"></script>
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/scripts-init/carousel-slider.js"></script>

<!--Circle Progress -->
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/vendors/circle-progress.js"></script>
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/scripts-init/circle-progress.js"></script>

<!--CountUp -->
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/vendors/count-up.js"></script>
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/scripts-init/count-up.js"></script>

<!--Cropper -->
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/vendors/cropper.js"></script>
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/scripts-init/image-crop.js"></script>
...
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/scripts-init/maps-word-map.js"></script>
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/scripts-init/maps.js"></script>

<!--Guided Tours -->
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/vendors/guided-tours.js"></script>
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/scripts-init/guided-tours.js"></script>

<!--Ladda Loading Buttons -->
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/vendors/ladda-loading.js"></script>
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/vendors/spin.js"></script>
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/scripts-init/ladda-loading.js"></script>

<!--Rating -->
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/vendors/rating.js"></script>
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/scripts-init/rating.js"></script>

<!--Perfect Scrollbar -->
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/vendors/scrollbar.js"></script>
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/scripts-init/scrollbar.js"></script>

<!--Toastr-->
<script src="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.js" crossorigin="anonymous"></script>
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/scripts-init/toastr.js"></script>

<!--SweetAlert2-->
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@8"></script>
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/scripts-init/sweet-alerts.js"></script>

<!--Tree View -->
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/vendors/treeview.js"></script>
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/scripts-init/treeview.js"></script>
...
<!--Tables Init-->
<script src="<?php echo base_url() ?>/assets/architectui-html-pro/assets_new/js/scripts-init/tables.js"></script>
