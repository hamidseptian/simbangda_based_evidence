...
class Pdf_jumlah_aktivitas extends FPDF
{
    public $pdf;
...
$judul = "LAPORAN PEKERJAAN SKPD PROVINSI SUMATERA BARAT TAHUN ".tahun_anggaran();
        ...
        $this->pdf->cell(88, 10, 'SKPD', 1, 0, 'C');
        $this->pdf->cell(20, 10, 'Pagu (Rp)', 1, 0, 'C');
        $this->pdf->cell(15, 10, "Program", 1, 0, 'C');
        $this->pdf->cell(15, 10, ' Kegiatan', 1, 0, 'C');
        $this->pdf->cell(15, 10, ' Sub Kegiatan', 1, 0, 'C');
    ...
    function Footer()
    {
        ...
        $this->pdf->Cell(0, 10, 'Powered By IT Biro Administrasi Pembangunan Tahun ' . tahun_anggaran(), 0, 0);
