    ...
    <tr style="background:#e0fbf3">
     ...
     foreach ($sub_kegiatan->result() as $key => $value_sk) {
      ...
      <td><?php echo $no_program.'.'.$no_kegiatan.'.'.$no_sub_kegiatan ?></td>
       ...
       <td align="center"  style="background:red"><?php echo $target['target_fisik'] =='' ? 0: $target['target_fisik'] ?>  untuk bulanan belum sesuai</td>
       <td align="center"  style="background:red"><?php echo $persen_target_keuangan ?>  untuk bulanan belum sesuai</td>
       ...
       <td align="center"  style="background:red"><?php echo $total_fisik ?> untuk bulanan belum sesuai</td>
