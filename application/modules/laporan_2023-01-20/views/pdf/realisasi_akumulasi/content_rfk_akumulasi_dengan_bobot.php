...
<table class="font_laporan border table">
 <thead class="header">
    ...
    <th rowspan="2" colspan="4" >Program, Kegiatan, Sub Kegiatan <?php echo $pagu_skpd ?></th>
...
<tfoot>
   ...
   <tr>
     ...
     <td align="center"><?php echo round($total_bobot_ski,2) ?></td>
