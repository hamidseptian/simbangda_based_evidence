...
<table class="font_laporan border">
  <thead class="header">
    ...
    <th rowspan="2" style="width:550px">Program, Kegiatan, Sub Kegiatan, Paket Pekerjaan</th>
    <th rowspan="2"> Pagu</th>
    <th rowspan="2"> Jenis Paket</th>
    <th rowspan="2"> Metode</th>
    <th rowspan="2"> Banyak <br>Volume <br>Pelaksanaan</th>
    <th rowspan="2"> Banyak <br>Lokasi  <br>Pelaksanaan</th>
    <th colspan="3">Evidence</th>
    <th rowspan="2">Nilai Paket <br> Pekerjaan</th>
   
  </tr>
  <tr>
    <th>Diupload</th>
    <th>Divalidasi</th>
    <th>Belum <br>Divalidasi</th>
  </tr>
  ...
  foreach ($program as $key => $value) { 
    ...
    <tr style="background: #f0e0fb">
      <td><?php echo $no_program ?></td>
       <td colspan="10" style="font-size:10px;"><div><b><?php echo $value->nama_program ?></b></div></td>
     </tr>
    <?php 
    $no_kegiatan=0;
    ...
    <tr style="background:#e0fbf3">
      <td><?php echo $no_program.'.'.$no_kegiatan ?></td>
       <td colspan="10" style="padding-left:1.5em" ><div class="nama_kegiatan"><b><?php echo $value_kegiatan->nama_kegiatan ?></b></div></td>
     </tr>
     <?php 
     foreach ($sub_kegiatan as $key => $value_sk) {
      ...
      $kategori_sub_kegiatan = $value_sk->kategori;
          ...
          $paket = $this->realisasi_akumulasi_model->get_paket_per_sub_kegiatan($id_instansi, $value_sk->kode_rekening_sub_kegiatan, $value_kegiatan->kode_rekening_program, $value_kegiatan->kode_bidang_urusan)->result_array();
      ...
      <td><?php echo $no_program.'.'.$no_kegiatan.'.'.$no_sub_kegiatan ?></td>
       <td style="padding-left:3em"  colspan="10"><div><?php echo $nama_sub_kegiatan?></div></td>
     ...
     <?php 
       foreach ($paket as $k_paket => $v_paket) { 
      ...
      <td><?php echo $no_program.'.'.$no_kegiatan.'.'.$no_sub_kegiatan.'.'.$no_paket ?></td>
       ...
       <td align="center"><?php echo $v_paket['evidence_diupload']?></td>
       <td align="center"><?php echo $divalidasi = $v_paket['evidence_diupload'] - $v_paket['belum_validasi'] ?></td>
       <td align="center"><?php echo $v_paket['belum_validasi']?></td>
...
?>
 <!-- </tbody> -->
   ...
   <tr>
     ...
     <td align="center"><?php echo $total_lokasi ?></td>
     <td align="center"><?php echo $total_evidence_diupload ?></td>
     <td align="center"><?php echo $total_evidence_divalidasi ?></td>
     <td align="center"><?php echo $total_evidence_belum_validasi ?></td>
