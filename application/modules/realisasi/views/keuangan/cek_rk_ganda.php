                                                        ...
                                                        <table class="table table-striped table-bordered">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th colspan="12">Realisasi Keuangan</th>
                                                                    <th rowspan="3">Total</th>
                                                                    <th rowspan="3">Option</th>
                                                                </tr>
                                                                <tr>
                                                                    <th colspan="4">Belanja Operasi</th>
                                                                    <th colspan="5">Belanja Modal</th>
                                                            ...
                                                            <tbody>
                                                                <?php 
                                                                    ...
                                                                    $total_semua = 0 ;
                                                                foreach ($rk as $k => $v) { 
                                                                    $total_perbulan = $v['bo_bp'] + $v['bo_bbj'] + $v['bo_bs'] + $v['bo_bh'] + $v['bm_bmt'] + $v['bm_bmpm'] + $v['bm_bmgb'] + $v['bm_bmjji'] + $v['bm_bmatl'] + $v['btt'] + $v['bt_bbh'] + $v['bt_bbk'];  
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><a href="<?php echo base_url('realisasi/hapus_rk_perbulan/'.sbe_crypt($v['id_realisasi_keuangan'])) ?>?krsk=<?php echo $v['kode_sub_kegiatan'] ?>&tahun=<?php echo $v['tahun'] ?>&kode_tahap=<?php echo $v['kode_tahap'] ?>" onclick="return confirm('Hapus realisasi keuangan bulan <?php echo bulan_global($v['bulan']) ?>.?');">Hapus</a></td>
