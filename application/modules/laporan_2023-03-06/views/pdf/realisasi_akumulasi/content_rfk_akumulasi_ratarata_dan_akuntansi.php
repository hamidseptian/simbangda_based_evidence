...
<tfoot>
   ...
   <tr>
    <?php 
     ...
     ?>
     <th colspan="3" align="center">Pencapaian Total (Secara Akuntansi) <sup>*)</sup></th>
   ...
   <tr>
     ...
     <th colspan="3" align="center">Pencapaian Total (Secara Ratarata) <sup>**)</sup></th>
     <th align="center"></th>
     ...
     <th align="center" colspan="2"><?php echo round($ratarata_target_keuangan,2) ?></th>
     <th align="center" colspan="2"><?php echo round($ratarata_realisasi_keuangan,2) ?></th>
     <th align="center" style="<?php echo $warna_peringatan_deviasi_keuangan_ratarata ?>"><?php echo $deviasi_keuangan_ratarata ?></th>
       <?php if ($ope=='<=') { ?>
       <th align="center"> - </th>
       <?php } ?>
