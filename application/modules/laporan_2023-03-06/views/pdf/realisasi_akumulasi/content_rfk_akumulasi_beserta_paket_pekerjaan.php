...
<table class="font_laporan border table">
 <thead class="header">
  ...
  <tr>
    ...
    <th style="width:80px">Jenis Paket</th>
...
<?php 
        ...
        foreach ($v_sub_kegiatan['data_paket'] as $k_paket => $v_paket) { ?>
        <tr>
