...
<table class="font_laporan border">
 <thead class="header">
    ...
    <th colspan="7">Keuangan </th>
     <?php if ($ope=='<=') { 
      $colspan_deviasi_keuangan_semua = 8;
      ?>
    ...
    <?php }else{
      ...
      $colspan_program_kegiatan = $colspan_deviasi_keuangan_semua + 5 + 2 ;
      $colspan_perhitungan_deviasi_sub_kegiatan = $colspan_program_kegiatan +1 ;
      $colspan_total_sub_kegiatan = $colspan_deviasi_keuangan_semua+ 5;
  ...
  <tr>
    ...
    <th>2</th>
    <th>3</th>
    <th style="background:#ddfbf4">4</th>
    <th style="background:#fbdddd">5=4/<?php echo $tot_subkeg ?></th>
    <th style="background:#ddfbf4">6</th>
    <th style="background:#fbdddd">7=6/<?php echo $tot_subkeg ?></th>
    <th style="background:#fafbdd">8=7-5</th>
    <th>9</th>
    <th>10=(9/3)*100</th>
    <th style="background:#fbdddd">11=(9/pagutotal)*100</th>
    <th>12</th>
    <th>13=(12/3)*100</th>
    <th style="background:#fbdddd">14=(12/pagutotal)*100</th>
    <th>15=13-10</th>
     <?php if ($ope=='<=') { ?>
    <th>15=3-12</th>
    <?php } ?>
 ...
 <!-- <tbody> -->
  ...
  foreach ($program as $key => $value) { 
    ...
    <tr style="background: #f0e0fb">
      <td><?php echo $no_program ?></td>
       <td colspan="<?php echo $colspan_program_kegiatan ?>" style="font-size:10px"><div><b><?php echo $value->nama_program ?></b></div></td>
     </tr>
    <?php 
    $no_kegiatan=0;
    ...
    <tr style="background:#e0fbf3">
     ...
     foreach ($sub_kegiatan->result() as $key => $value_sk) {
      ...
      <td><?php echo $no_program.'.'.$no_kegiatan.'.'.$no_sub_kegiatan ?></td>
       ...
       <td align="center"> <?php echo round($porsi_target_fisik,2) ?> </td>
       <td align="center" style="background:#ececec"><?php echo round($total_realisasi_fisik,2) ?></td>
       <td align="center"> <?php echo round($porsi_realisasi_fisik,2) ?> </td>
       ...
       <td align="center"> <?php echo round($persen_target_keuangan_besar,2) ?> </td>
       ...
       <td align="center"> <?php echo round($persen_realisasi_keuangan_besar,2) ?> </td>
       <td align="center" style="<?php echo $warna_peringatan_dev_keu ?>"><?php echo ROUND($dev_keu, 2) ?></td>
       <?php if ($ope=='<=') { ?>
       <td align="center"> <?php echo number_format($sisa_pagu) ?> </td>
       <?php } ?>
  ...
  <?php 
      ...
      $deviasi_total_keuangan = $persen_realisasi_keuangan_total - $nilai_total_persen_target_keuangan ; 
?>
 <!-- </tbody> -->


   <tr>
     <td colspan="2" align="center">Pencapaian (Secara Akuntansi) <sup>*)</sup></td>
     <td align="right"><?php echo number_format($total_pagu_sub_kegiatan_instansi) ?></td>
     <td align="center"> <?php echo $total_target_fisik ?> </td>
     <td > <?php echo round($total_porsi_target_fisik,2) ?> </td>
     <td > <?php echo round($total_realisasi_fisik_semua,2) ?> </td>
     <td > <?php echo round($total_porsi_realisasi_fisik,2) ?> </td>
     ...
     <td align="center"> <?php echo round($nilai_total_persen_target_keuangan,2) ?> </td>
     <td align="center"> <?php echo round($total_persen_target_keuangan_besar,2) ?> </td>
     <td align="right"> <?php echo number_format($total_realisasi_keuangan) ?> </td>
     <td align="center"> <?php echo round($persen_realisasi_keuangan_total,2) ?> </td>
     <td align="center"> <?php echo round($total_persen_realisasi_keuangan_besar,2) ?> </td>
     <td align="center"> <?php echo round($deviasi_total_keuangan,2) ?> </td>
    ...
    <!--  <td align="center" style="background:red"><?php echo $grafik->target_fisik ?></td>
 ...
 ?>
     ...
     <td align="center" style="background:red"><?php echo round($ratarata_fisik,2) ?></td> -->
   ...
   <tr style="background: #fbdddd ">
    ...
    $deviasi_keuangan_ratarata = $ratarata_realisasi_keuangan - $ratarata_target_keuangan ; 
     ?>
     <td colspan="2" align="center">Pencapaian (Secara Ratarata) <sup>**)</sup></td>
     <td></td>
     <td><?php echo round($ratarata_target_fisik,2) ?></td>
     <td></td>
     <td></td>
     <td></td>
     <td></td>
     <td></td>
     <td><?php echo round($total_persen_target_keuangan,2) ?> / <?php echo  $tot_subkeg ?></td>
     <td><?php echo round($ratarata_target_keuangan,2) ?></td>
     <td></td>
     <td><?php echo round($total_persen_realisasi_keuangan,2) ?> / <?php echo  $tot_subkeg ?></td>
     <td><?php echo round($ratarata_realisasi_keuangan,2) ?></td>
     <td><?php echo round($deviasi_keuangan_ratarata,2) ?></td>
    ...
    <tr style="background: #f8b2b2;">
      ...
      <td colspan="5"><center><?= $total_peringatan_dev_fisik_merah  ?></center></td>
    ...
    <tr style="background: #fcf3cf;">
      ...
      <td colspan="5"><center><?= $total_peringatan_dev_fisik_kuning  ?></center></td>
    ...
    <tr style="background: #d5f5e3;">
      ...
      <td colspan="5"><center><?= $total_peringatan_dev_fisik_hijau  ?></center></td>
