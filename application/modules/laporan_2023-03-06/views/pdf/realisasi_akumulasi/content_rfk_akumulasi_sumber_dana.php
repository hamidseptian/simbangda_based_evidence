    ...
    ?>
     ...
     foreach ($sub_kegiatan as $key => $value_sk) {
      ...
      $total_pagu_sub_kegiatan_instansi +=$value_sk->pagu ;
          ...
          $sumber_dana = $this->realisasi_akumulasi_model->get_sumber_dana($id_instansi, $value_sk->kode_rekening_sub_kegiatan, $value_sk->kode_rekening_kegiatan, $value_sk->kode_rekening_program, $value_sk->kode_bidang_urusan, $value_sk->kode_tahap)->row_array();
