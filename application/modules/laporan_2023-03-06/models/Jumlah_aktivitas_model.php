...
class Jumlah_aktivitas_model extends CI_Model
{
  ...
  public function sub_kegiatan($id_instansi)
  {
    $tahap = tahapan_apbd();
    $query  = $this->db->query("SELECT kode_rekening_kegiatan from v_sub_kegiatan_apbd where id_instansi = '$id_instansi' and kode_tahap='$tahap'");
    return $query->num_rows();
  }
