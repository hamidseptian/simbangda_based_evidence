...
class Testing extends MY_Controller
{
	...
	public function index()
	{
            ...
            $data['program']        = $this->db->query("SELECT * from sub_kegiatan_instansi whre id_instansi='$id_instansi' and tahun='$tahun'");
    		$data['link']           = $this->router->fetch_method();
    		$data['menu']           = $this->load->view('layout/menu', $data, true);
    		$data['extra_css']		= $this->load->view('testing/css', $data, true);
    		$data['extra_js']		= $this->load->view('testing/js', $data, true);
    		$data['modal']		= $this->load->view('testing/modal', $data, true);
