                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group required">
                              <label for="latitude" class="control-label"><b>Kode Koordinat</b></label>
                              <div class="input-group">
                                <input type="text" class="form-control calcius" name="kode_koordinat" id="kode_koordinat" placeholder="Latitude">
...
<!-- pilih paket -->
<div class="modal fade" id="modal_pilih_paket" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Pilih Paket Pekerjaan</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                 ...
                 <table id="table-paket" class="display" style="width:100%">
                   <thead>
                     <tr>
                       <td>No</td>
