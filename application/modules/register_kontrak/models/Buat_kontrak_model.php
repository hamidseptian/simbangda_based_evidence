	...
	public function detail_paket($id_paket_pekerjaan)
	{
		$query  = $this->db->query("SELECT
						...
						FROM
							...
							and paket.id_instansi = keg.id_instansi
							left join users_sub_kegiatan usk on keg.kode_rekening_sub_kegiatan = usk.kode_rekening_sub_kegiatan and keg.tahun=usk.tahun_anggaran and keg.kode_tahap=usk.kode_tahap and paket.id_instansi=usk.id_instansi
