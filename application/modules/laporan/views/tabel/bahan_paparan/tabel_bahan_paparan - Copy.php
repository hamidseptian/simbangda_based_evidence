                                                ...
                                                <div class="row">
                                                 ...
                                                 <div class="col-md-6">
                                                    <div class="mb-3 card">
                                                      ...
                                                      <div class="card-header">
                                                                           <label>
                                                          Perengkingan Pendapatan 3 Tahun Terakhir</label>
                                                                        <div class="btn-actions-pane-right">
                                                                        </div>
                                                                    </div>
                                                        <div class="card-body">
...
function lihat_realisasi_fisik_inspektorat(){
    $('#data_realisasi_fisik_inspektorat').modal('show');
}
function lihat_realisasi_keuangan_inspektorat(){
    $('#data_realisasi_keuangan_inspektorat').modal('show');
}
...
Highcharts.chart('grafik_realisasi_keuangan_inspektorat', {
  ...
  series: [
    ...
    },
    {
      ...
      <?php foreach ($grafik_realisasi_keuangan_asisten['inspektorat'] as $key => $value) { 
        $urutan = $key+1;
           if ($value['rk']<$ratarata_realisasi_fisik) {
                $warna = '#FFA2A2';
            }else{
                $warna = '#05DF72';
