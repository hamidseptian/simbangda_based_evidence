...
<div class="modal fade" id="data_realisasi_fisik_inspektorat" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Data realisasi fisik <br>Inspektorat</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
               <table class="table">
                   ...
                   <?php 
                   $no_rf = 1;
                   foreach ($grafik_realisasi_fisik_asisten['inspektorat'] as $v) { ?>
                      <tr>
                           <td><?php echo $no_rf++ ?></td>
                           <td><?php echo $v['skpd'] ?></td>
                           <td><?php echo $v['singkatan_skpd'] ?></td>
...
<div class="modal fade" id="data_realisasi_keuangan_inspektorat" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Data realisasi keuangan <br>Inspektorat</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
               <table class="table">
                   ...
                   <?php 
                   $no_rf = 1;
                   foreach ($grafik_realisasi_keuangan_asisten['inspektorat'] as $v) { ?>
                      <tr>
                           <td><?php echo $no_rf++ ?></td>
                           <td><?php echo $v['skpd'] ?></td>
                           <td><?php echo $v['singkatan_skpd'] ?></td>
