...
$batasan = 50 ; 
$tanda_background = "style='background: #f1c3c3'";
...
<?php 
    foreach ($v_program['data_kegiatan'] as $k_kegiatan => $v_kegiatan) { 
        ...
        if ($v_kegiatan['persen_rk_kegiatan'] < $batasan) {
          $tanda_rk_kegiatan = $tanda_background ;
        }else{
          $tanda_rk_kegiatan = "";

        }
        if ($v_kegiatan['persen_rf_kegiatan'] < $batasan) {
          $tanda_rf_kegiatan = $tanda_background;
        }else{
          $tanda_rf_kegiatan = "";
      ...
      ?>
       ...
       <tr style="background: #d6eaf8 ">
        ...
        <th align="center"  <?php echo $tanda_rf_kegiatan ?>> <?php echo round($v_kegiatan['persen_rf_kegiatan'],2) ?></th>
        ...
        <th align="center" <?php echo $tanda_rk_kegiatan ?>> <?php echo round($v_kegiatan['persen_rk_kegiatan'],2) ?></th>
...
<?php  
      foreach ($v_kegiatan['data_sub_kegiatan'] as $k_ski => $v_sub_kegiatan) { 
        ...
        // if ($v_sub_kegiatan['persen_rk_sub_kegiatan'] < $batasan) {
        //  $tanda_rk_ski = $tanda_background ;
        // }else{
        //  $tanda_rk_ski = "";

        // }
        // if ($v_sub_kegiatan['persen_rf_sub_kegiatan'] < $batasan) {
        //  $tanda_rf_ski = $tanda_background;
        // }else{
        //  $tanda_rf_ski = "";
        ...
        ?>
          <tr>
            ...
            <td align="center"  <?php echo $tanda_rf_ski ?>> <?php echo round($v_sub_kegiatan['persen_rf_sub_kegiatan'],2) ?></td>
            ...
            <td align="center" <?php echo $tanda_rk_ski ?>> <?php echo round($v_sub_kegiatan['persen_rk_sub_kegiatan'],2) ?></td>
