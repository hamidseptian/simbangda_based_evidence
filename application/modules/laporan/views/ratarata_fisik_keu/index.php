            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <select name="realisasi" id="realisasi" class="form-control">
                        ...
                        <option value="fisik_tertinggi">Berdasarkan Realisasi Fisik Tertinggi</option>
                        <option value="fisik_terendah">Berdasarkan Realisasi Fisik Terendah</option>
                        <option value="keu_tertinggi">Berdasarkan Realisasi Keuangan Tertinggi</option>
                        <option value="keu_terendah">Berdasarkan Realisasi Keuangan Terendah</option>
                        <option value="dev_fisik_tertinggi">Berdasarkan Deviasi Fisik Tertinggi</option>
