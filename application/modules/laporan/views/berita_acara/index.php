		...
		<div class="row">
			...
			<div class="col-md-2">
				<div class="form-group">
					<label for="kategori_laporan"><strong>Jenis Berita Acara</strong></label>
					<select name="kategori_laporan" id="kategori_laporan" class="form-control">
						...
						$kategori_laporan = [
							'rfk_akumulasi'=>'Realisasi Fisik Dan Keuangan Akumulasi',
								...
								$kategori_laporan = [
									'rekon'=>'Rekonsiliasi Simbangda Based Evidence',
			...
			<div class="col-md-2">
				<div class="form-group">
					<label for="tahun"><strong>Periode Rekon</strong></label>
					<select name="tahun" id="tahun" class="form-control" >
						<option>Buat tabel periode rekon</option>
					</select>
				</div>
			</div>
			<div class="col-md-2">
