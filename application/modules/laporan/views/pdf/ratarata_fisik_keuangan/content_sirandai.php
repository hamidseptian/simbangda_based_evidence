   ...
   $bg_rea_fisik =  '';//$realisasi=='fisik' ? 'background: #e5e8e8 ' :'';
    ...
    <table class="font_laporan table">
       <thead class="header">
          ...
          <th rowspan="4" style="width:90px"> Pagu</th>
          <th colspan="4"> Fisik</th>
          <th colspan="6"> Keuangan</th>
          <th  rowspan="4">Sirandai</th>
          <th  rowspan="4" style="width:110px">Last Update</th>
        ...
        <?php
         ...
         foreach ($skpd as $v) { 
            $total_t_fisik_satu    += $v['tf'];
              ...
              $persen_sirandai = (0.6 * $v['cf']) + (0.4 * $v['ck']);
          $no++;
          ?>
           <tr <?php echo $warning ?>>
            ...
            <td align=" center"><?php echo $persen_sirandai ?></td>
      ...
      <!--   <tr>
        ...
        <tr>
          ...
          <?php   
              $persen_sirandai_al = (0.6 * $pencapaian_fisik_satu) + (0.4 * $pencapaian_keu_satu); ?>
          <td align="center" style="<?php echo  $warna_peringatan_deviasi_ratarata_keu ?>"><?php echo round($deviasi_ratarata_keu,2); ?></td>
          <td align=" center"><?php echo round($persen_sirandai_al,2) ?></td>
             <td align="center">-</td>
        </tr>
      </tfoot>
