    ...
    $sisa_anggaran_kegiatan =0;
     ...
     foreach ($sub_kegiatan->result() as $key => $value_sk) {
      ...
      $total_pagu_sub_kegiatan_instansi +=$value_sk->pagu ;
          ...
          $nilai_realisasi_rutin = $persen_realisasi_keuangan > 95 ? 100 : $persen_realisasi_keuangan;
          $rut = $jenis_rutin > 0 ? $nilai_realisasi_rutin : 0;
...
<tfoot>
   ...
   <tr>
     ...
     <?php  if ($pagu_skpd==$total_pagu_sub_kegiatan_instansi) {
       $css_kesamaan_pagu = 'style="background: #dbc3e7 "';
     }else{
