...
$pagu_bo = $this->realisasi_akumulasi_model->total_pagu_sub_kegiatan($value_sk->kode_rekening_sub_kegiatan, $tahap, $id_instansi, 'pagu_bo')->row_array()['pagu_bo'];
        ...
        $pen = $this->realisasi_akumulasi_model->get_realisasi_fisik($id_instansi, $value_sk->kode_rekening_sub_kegiatan, $bulan, 'PENYEDIA', $ope, $tahun, $tahap)->row_array();
          ...
          $total_fisik_semua +=$total_fisik;
            ...
            $data_ski = [
              ...
              'rp_realisasi_bo_ski'=> $show_realisasi_bo,
              'rp_realisasi_bm_ski'=> $show_realisasi_bm,
              'rp_realisasi_btt_ski'=> $show_realisasi_btt,
              'rp_realisasi_bt_ski'=> $show_realisasi_bt,
      ...
      <td><?php echo pilihan_nama_tahapan($tahap) ?></td>
  ...
  <?php 
      ...
      $persen_realisasi_bo_semua = $total_realisasi_bo > 0 ? ($total_realisasi_bo / $total_pagu_bo) * 100 : 0 ;
      $persen_realisasi_bm_semua = $total_realisasi_bm > 0 ? ($total_realisasi_bm / $total_pagu_bm) * 100 : 0 ;
      $persen_realisasi_btt_semua = $total_realisasi_btt > 0 ? ($total_realisasi_btt / $total_pagu_btt) * 100 : 0 ;
      $persen_realisasi_bt_semua = $total_realisasi_bt > 0 ? ($total_realisasi_bt / $total_pagu_bt) * 100 : 0 ;
      $persen_realisasi_semua = $total_realisasi_semua > 0 ? ($total_realisasi_semua / $total_pagu_semua) * 100 : 0 ;
      $persen_fisik_total = $total_fisik_semua/$total_sub_kegiatan;
...
?>
 <!-- </tbody> -->
   ...
   <tr>
     ...
     <td align="right"><?php echo number_format($total_pagu_semua) ?></td>

     <td align="right"><?php echo number_format($total_realisasi_bo) ?></td>
     <td align="center"><?php echo round($persen_realisasi_bo_semua,2) ?></td>
     <td align="right"><?php echo number_format($total_realisasi_bm) ?></td>
     <td align="center"><?php echo round($persen_realisasi_bm_semua,2) ?></td>
     <td align="right"><?php echo number_format($total_realisasi_btt) ?></td>
     <td align="center"><?php echo round($persen_realisasi_btt_semua,2) ?></td>
     <td align="right"><?php echo number_format($total_realisasi_bt) ?></td>
     <td align="center"><?php echo round($persen_realisasi_bt_semua,2) ?></td>
     <td align="right"><?php echo number_format($total_realisasi_semua) ?></td>
     <td align="center"><?php echo round($persen_realisasi_semua,2) ?></td>
     <td align="center"><?php echo round($persen_fisik_total,2) ?></td>
