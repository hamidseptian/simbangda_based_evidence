...
$total_rft_ski = 0;
  ...
  foreach ($program as $key => $value) { 
    ...
    // $pagu_kegiatan =0;
      $kode_kegiatan = $value_kegiatan->kode_rekening_kegiatan;
     if ($kode_tahap==4) {
     ...
     foreach ($sub_kegiatan->result() as $key => $value_sk) {
      ...
      $total_pagu_sub_kegiatan_instansi +=$value_sk->pagu ;
          ...
          // $rut = $jenis_rutin > 0 ? ($jenis_rutin * $realisasi_rutin) : 0;
           ...
           if ($tahun<2023) {
              $realisasi_rutin_ok = $realisasi_rutin;
           }
           elseif ($tahun==2023) {
              $realisasi_rutin_ok = $persen_realisasi_keuangan > 90 ? 100 : $persen_realisasi_keuangan;
           }else{
              $rf_rutin = $this->realisasi_akumulasi_model->get_realisasi_fisik($id_instansi, $value_sk->kode_rekening_sub_kegiatan, $bulan, 'RUTIN', $ope, $tahun, $tahap)->row_array();
              $realisasi_rutin_ok = $rf_rutin['total'] == ' ' ? 0 : $rf_rutin['total'];//$persen_realisasi_keuangan > 90 ? 100 : $persen_realisasi_keuangan;
           }



          $rut = $jenis_rutin > 0 ? ($realisasi_rutin_ok * $jenis_rutin) : 0;
          ...
          if ($total_paket != 0) {
            $jumlah_fisik_per_sub_kegiatan = ($swa_tot + $pen_tot + $rut_tot) / $total_paket;
            $total_fisik  = $jumlah_fisik_per_sub_kegiatan > 100 ? 100 : $jumlah_fisik_per_sub_kegiatan;
      ...
      ?>
       ...
       <?php 
          ...
          if ($total_realisasi_fisik>0) {
            $capaian_realisasi_fisik = ($total_realisasi_fisik / $target_fisik ) * 100 ; 
            # code...
          }else{
            $capaian_realisasi_fisik = 0 ; 

          }
          if ($persen_realisasi_keuangan) {
            $capaian_realisasi_keuangan = ($persen_realisasi_keuangan / $persen_target_keuangan ) * 100 ; 
          }else{
  ...
  <?php 
        ...
        if ($pagu_kegiatan >0 ) {
            # code...
          $tampilkan_persen_tf_kegiatan = $total_tft_ski_per_kegiatan;//$persen_tf_kegiatan / $banyak_sub_kegiatan;
          $tampilkan_persen_rf_kegiatan = $total_rft_ski_per_kegiatan;//$persen_rf_kegiatan / $banyak_sub_kegiatan;
          ...
          $tampilkan_persen_tf_kegiatan = 0;
          $tampilkan_persen_rf_kegiatan = 0;
          $tampilkan_persen_df_kegiatan = 0;

          $tampilkan_persen_tk_kegiatan = 0;
          $tampilkan_persen_rk_kegiatan = 0;
          $tampilkan_persen_dk_kegiatan = 0;
        }
        ...
        $sisa_anggaran_program += $sisa_anggaran_kegiatan;
          ...
          $bobot_kegiatan =($pagu_kegiatan/$pagu_skpd)*100;
          $tft_kegiatan =$tampilkan_persen_tf_kegiatan * $bobot_kegiatan /100;
          $rft_kegiatan =$tampilkan_persen_rf_kegiatan * $bobot_kegiatan /100;


          $persen_capaian_fisik_kegiatan  = $tampilkan_persen_tf_kegiatan == 0 ? INF : ($tampilkan_persen_rf_kegiatan / $tampilkan_persen_tf_kegiatan) * 100 ; 
          $persen_capaian_keuangan_kegiatan  = $tampilkan_persen_tk_kegiatan == 0 ? INF : ($tampilkan_persen_rk_kegiatan / $tampilkan_persen_tk_kegiatan) * 100 ; 
        ...
        $data_kegiatan = [
          ...
          'bobot_kegiatan'=>$bobot_kegiatan,
          'tft_kegiatan'=>$tft_kegiatan,
          'rft_kegiatan'=>$rft_kegiatan,
          ...
          'persen_capaian_fisik_kegiatan'=> $persen_capaian_fisik_kegiatan,
          ...
          'persen_capaian_keuangan_kegiatan'=> $persen_capaian_keuangan_kegiatan,
      ...
      if ($pagu_program>0) {
        $tampilkan_persen_tf_program = $total_tft_ski_per_program;//$persen_tf_program / $banyak_kegiatan;
        $tampilkan_persen_rf_program = $total_rft_ski_per_program;//$persen_rf_program / $banyak_kegiatan;
        ...
        $tampilkan_persen_dk_program = $tampilkan_persen_rk_program - $tampilkan_persen_tk_program;
         ...
         $tampilkan_persen_tf_program = 0;
        $tampilkan_persen_rf_program = 0;
        $tampilkan_persen_df_program = 0;


        $tampilkan_persen_tk_program = 0;
        $tampilkan_persen_rk_program = 0;
        $tampilkan_persen_dk_program = 0;
      }
      ...
      $bobot_program =($pagu_program/$pagu_skpd)*100;
      $tft_program =$tampilkan_persen_tf_program * $bobot_program /100;
      $rft_program =$tampilkan_persen_rf_program * $bobot_program /100;



         $persen_capaian_fisik_program  = $tampilkan_persen_tf_program == 0 ? INF : ($tampilkan_persen_rf_program / $tampilkan_persen_tf_program) * 100 ; 
          $persen_capaian_keuangan_program  = $tampilkan_persen_tk_program == 0 ? INF : ($tampilkan_persen_rk_program / $tampilkan_persen_tk_program) * 100 ; 
      ...
      $data_program = [
          ...
          'nama_program'=> $kumpul_master_program[$value->kode_rekening_program],
          'pagu_program'=>$pagu_program,



          'bobot_program'=>$bobot_program,
          'tft_program'=>$tft_program,
          'rft_program'=>$rft_program,
          ...
          'persen_capaian_fisik_program'=> $persen_capaian_fisik_program,
          ...
          'persen_capaian_keuangan_program'=> $persen_capaian_keuangan_program,
      ...
      $nilai_total_persen_target_keuangan = $total_pagu_sub_kegiatan_instansi == 0 ? 0 : ($total_angka_target_keuangan / $total_pagu_sub_kegiatan_instansi) * 100;
      $persen_realisasi_keuangan_total = $total_pagu_sub_kegiatan_instansi == 0 ? 0 : ($total_realisasi_keuangan / $total_pagu_sub_kegiatan_instansi) * 100 ;
...
?>
    ...
    // $ratarata_fisik = $total_fisik_semua / $total_sub_kegiatan ; 
     $ratarata_target_fisik = $tot_subkeg== 0 ? 0 : $total_target_fisik / $tot_subkeg;
     $ratarata_realisasi_fisik = $tot_subkeg== 0 ? 0 : $total_realisasi_fisik_semua / $tot_subkeg;
     $deviasi_fisik_total =  round($ratarata_realisasi_fisik,2) - round($ratarata_target_fisik,2) ;

    $ratarata_target_keuangan = $tot_subkeg== 0 ? 0 : $total_persen_target_keuangan / $tot_subkeg;
    $ratarata_realisasi_keuangan = $tot_subkeg== 0 ? 0 : $total_persen_realisasi_keuangan / $tot_subkeg;
...
<table class="font_laporan border table"> <thead class="header"> <tr> <th
rowspan="3"  width="30px"><?php echo $var ?></th> <th rowspan="2" colspan="4"
>Program, Kegiatan, Sub Kegiatan</th> <th rowspan="2">Bobot</th> <!-- <th
rowspan="3" style="width:80px">Pagu Anggaran</th> --> <th colspan="6">Fisik
</th> <th colspan="6">Keuangan </th> <?php if ($ope=='<=') { 
$colspan_deviasi_keuangan_semua = 7; ?> <th rowspan="2"
style="width:80px">Sisa Anggaran</th> <?php }else{
...
$total_peringatan_dev_program_fisik_ungu = 0;
...
$total_peringatan_dev_program_keu_ungu = 0;
...
$total_peringatan_dev_kegiatan_fisik_ungu = 0;
...
$total_peringatan_dev_kegiatan_keu_ungu = 0;
   ...
   foreach ($kumpul_program as $k_program => $v_program) { 
    ...
    elseif ($deviasi_fisik_program <=0  && $deviasi_fisik_program >=-5) {
      $warna_peringatan_deviasi_fisik_program = 'background: #d5f5e3';
      $total_peringatan_dev_program_fisik_kuning += 1 ;
    }else{
      $warna_peringatan_deviasi_fisik_program = 'background:  #ff7cfd ';
      $total_peringatan_dev_program_fisik_ungu += 1 ;
    }
    ...
    elseif ($deviasi_keuangan_program <=0  && $deviasi_keuangan_program >=-5) {
      $warna_peringatan_deviasi_keuangan_program = 'background: #d5f5e3';
      $total_peringatan_dev_program_keu_hijau += 1 ;
    }else{
      $warna_peringatan_deviasi_keuangan_program = 'background:  #ff7cfd ';
      $total_peringatan_dev_program_keu_ungu += 1 ;
    }
  ...
  <tr style="background: #c6d1fa ">
    ...
    <th><?php echo round($v_program['bobot_program'],2) ?></th>
    <th align="center"> <?php echo round($v_program['persen_tf_program'],2) ?></th>
    <th><?php echo round($v_program['tft_program'],2) ?></th>
    <th align="center"> <?php echo round($v_program['persen_rf_program'],2) ?></th>
    <th><?php echo round($v_program['rft_program'],2) ?></th>
    <th><?php echo round($v_program['persen_capaian_fisik_program'],2) ?></th>
    ...
    <th><?php echo round($v_program['persen_capaian_keuangan_program'],2) ?></th>
...
<?php 
    ...
    foreach ($v_program['data_kegiatan'] as $k_kegiatan => $v_kegiatan) { 
      ...
      elseif ($deviasi_fisik_kegiatan <=0  && $deviasi_fisik_kegiatan >=-5) {
        $warna_peringatan_deviasi_fisik_kegiatan = 'background: #d5f5e3';
        $total_peringatan_dev_kegiatan_fisik_kuning += 1 ;
      }else{
        $warna_peringatan_deviasi_fisik_kegiatan = 'background:  #ff7cfd ';
        $total_peringatan_dev_kegiatan_fisik_ungu += 1 ;
      }
      ...
      elseif ($deviasi_keuangan_kegiatan <=0  && $deviasi_keuangan_kegiatan >=-5) {
        $warna_peringatan_deviasi_keuangan_kegiatan = 'background: #d5f5e3';
        $total_peringatan_dev_kegiatan_keu_hijau += 1 ;
      }else{
        $warna_peringatan_deviasi_keuangan_kegiatan = 'background:  #ff7cfd ';
        $total_peringatan_dev_kegiatan_keu_ungu += 1 ;
      }
      ...
      ?>
       ...
       <tr style="background: #c6faf8  ">
        ...
        <th><?php echo round($v_kegiatan['bobot_kegiatan'],2) ?></th>
        <th align="center"> <?php echo round($v_kegiatan['persen_tf_kegiatan'],2) ?></th>
        <th><?php echo round($v_kegiatan['tft_kegiatan'],2) ?></th>
        <th align="center"> <?php echo round($v_kegiatan['persen_rf_kegiatan'],2) ?></th>
        <th><?php echo round($v_kegiatan['rft_kegiatan'],2) ?></th>
        <th align="center"> <?php echo round($v_kegiatan['persen_capaian_fisik_kegiatan'],2) ?></th>
        ...
        <th align="center"> <?php echo round($v_kegiatan['persen_capaian_keuangan_kegiatan'],2) ?></th>
...
<?php  
      ...
      foreach ($v_kegiatan['data_sub_kegiatan'] as $k_ski => $v_sub_kegiatan) { 
      		...
      		if (round($v_sub_kegiatan['persen_tf_sub_kegiatan'],2)<round($v_sub_kegiatan['persen_tk_sub_kegiatan'],2)) {
      			$bg_tf = "style='background: #f8eafa '";
      		}else{
      			$bg_tf = "";

      		}

          if (round($v_sub_kegiatan['persen_rf_sub_kegiatan'],2)<round($v_sub_kegiatan['persen_rk_sub_kegiatan'],2)) {
            $bg_rf = "style='background: #f8eafa '";
          }else{
            $bg_rf = "";

          }
          $bobot_ski_per_kegiatan = $v_kegiatan['pagu_kegiatan'] == 0 ? 0 : ($v_sub_kegiatan['pagu_sub_kegiatan'] / $v_kegiatan['pagu_kegiatan']) *100;
          $tft_ski_per_kegiatan = $v_sub_kegiatan['persen_tf_sub_kegiatan'] * $bobot_ski_per_kegiatan/100;
          ...
          <tr>
            ...
            <td align="center"><?php echo round($v_sub_kegiatan['bobot_ski'],2) ?></td>
            <td align="center" <?php echo $bg_tf ?>> <?php echo round($v_sub_kegiatan['persen_tf_sub_kegiatan'],2) ?></td>
            <td align="center"><?php echo round($v_sub_kegiatan['tft_ski'],2) ?></td>
            <td align="center"  <?php echo $bg_rf ?>> <?php echo round($v_sub_kegiatan['persen_rf_sub_kegiatan'],2) ?></td>
            <td align="center"><?php echo round($v_sub_kegiatan['rft_ski'],2) ?></td>
            <td align="center"> <?php echo round($v_sub_kegiatan['persen_capaian_rf_sub_kegiatan'],2) ?></td>
            ...
            <td align="center"> <?php echo round($v_sub_kegiatan['persen_capaian_rk_sub_kegiatan'],2) ?></td>
...
<tfoot>
   ...
   <tr>
     ...
     <?php  if ($pagu_skpd==$total_pagu_sub_kegiatan_instansi) {
       $css_kesamaan_pagu = '';
     }else{
       $css_kesamaan_pagu = 'style="background: #e8d8f0 "';

     } ?>
     <td align="right" <?php echo  $css_kesamaan_pagu; ?>><?php echo number_format($total_pagu_sub_kegiatan_instansi) ?></td>
     <td align="center" <?php echo $css_kesamaan_pagu; ?>><?php echo round($total_bobot_ski,2) ?></td>
     <td align="center" align="center"> <?php echo $total_target_fisik ?> </td>
     <td align="center"><?php echo round($total_tft_ski,2) ?></td>
     <td align="center"> <?php echo round($total_realisasi_fisik_semua,2) ?> </td>
     <td align="center"><?php echo round($total_rft_ski,2) ?></td>
     ...
     <td align="center"> --  <?php //echo round($deviasi_total_keuangan_akuntansi,2) ?> </td>
      ...
      <?php if ($ope=='<=') { ?>
       <td align="right"> <?php echo number_format($sisa_pagu_total) ?> </td>
       <?php } ?>
   </tr>
   <tr>
    <?php 
	    ...
	    $deviasi_fisik_total = round(($rf_pencapaian-$tf_pencapaian),2);
	    // $deviasi_keuangan_kegiatan = round($v_kegiatan['persen_dk_kegiatan'],2);

	     $deviasi_keuangan_total = round($persen_realisasi_keuangan_total,2) - round($nilai_total_persen_target_keuangan,2) ; 
        ...
        if ($rf_pencapaian>0) {
            ...
            $capaian_realisasi_fisik_total = ($rf_pencapaian /$tf_pencapaian ) * 100 ; 
        }else{
            $capaian_realisasi_fisik_total = 0 ; 
        }
        if ($persen_realisasi_keuangan_total>0) {
            $capaian_realisasi_keuangan_total = ($persen_realisasi_keuangan_total / $nilai_total_persen_target_keuangan) * 100 ; 
        }else{
            $capaian_realisasi_keuangan_total = 0 ; 
          
        }

        if ($ope=='<=') {
           if ($total_realisasi_keuangan==$grafik['rp_realisasi_keuangan_akumulasi'] && $total_angka_target_keuangan==$grafik['rp_target_keuangan_akumulasi'] && round($tf_pencapaian,2)==$grafik['target_fisik_akumulasi'] && round($rf_pencapaian,2)==$grafik['realisasi_fisik_akumulasi']) {
            $status_synch = 'Terakhir synchronize pada '.$grafik['last_update'];
          }else{
            $status_synch = 'Belum di synchronize | '.'Terakhir synchronize pada '.$grafik['last_update'];
          }
     ...
     ?>
     <td colspan="4" align="center"><b>Pencapaian</b> <br> <?php echo $status_synch.'<br>';?></td>

     <th align="center">-</th>
     <th align="center">-</th>
     
      <th colspan="2"><?php echo round($tf_pencapaian,2) ?></th>
     <th colspan="2"><?php echo round($rf_pencapaian,2) ?></th>
     <th align="center"> <?php echo round($capaian_realisasi_fisik_total,2) ?> </th>
...
<table class="table font_laporan ">
 <thead>
    ...
    <tr style="background:  #ff7cfd ;">
      ...
      <td align="center"><?= $total_peringatan_dev_program_fisik_ungu?></td>
      <td align="center"><?= $total_peringatan_dev_program_keu_ungu?></td>
      <td align="center"><?= $total_peringatan_dev_kegiatan_fisik_ungu?></td>
      <td align="center"><?= $total_peringatan_dev_kegiatan_keu_ungu?></td>
      <td align="center"><?= $total_peringatan_dev_fisik_ungu  ?></td>
      <td align="center"><?= $total_peringatan_dev_keu_ungu  ?></td>
    </tr>
     <tr>
