...
<table class="font_laporan border table">
 <thead class="header">
  ...
  <tr>
    <th>Target</th>
    <th>Realisasi</th>
    <th style="width:35px;">Deviasi</th>
 ...
 <tbody>
  ...
  <tr style="background: aqua" >
    ...
    <td colspan="15"><b><?php echo $v_skpd['nama_instansi'] ?></b></td>
  </tr>
  ...
  <?php foreach ($v_skpd['data_program'] as $k_program => $v_program) { ?>
   <tr style="background: #c6d1fa">
    ...
    <td colspan="15"><?php echo $v_program['nama_program'] ?></td>
  ...
  <?php foreach ($v_program['data_kegiatan'] as $k_kegiatan => $v_kegiatan) { ?>
   <tr style="background: #c6faf8">
    ...
    <td colspan="15"><?php echo $v_kegiatan['nama_kegiatan'] ?></td>
  </tr>
...
$pencapaian_rk_persen = $v_skpd['total_rk_rp_ski_skpd'] / $v_skpd['total_pagu_ski_skpd'] * 100 ; 
 ...
 <tfoot>
   ...
   <tr>
     ...
     <th>-</th>
     <th>-</th>
     <th ><?php echo round($pencapain_tf_total,2) ?></th>
     <th ><?php echo round($pencapain_rf_total,2) ?></th>
