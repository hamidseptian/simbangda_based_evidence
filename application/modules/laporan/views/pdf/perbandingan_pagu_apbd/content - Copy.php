...
<table class="font_laporan border">
 <thead class="header">
    ...
    <th rowspan="2" colspan="6">Sumber Dana (Rp.)</th>
  ...
  <tr>
    ...
    <th style="width:80px">DAK Fisik</th>
    <th style="width:80px">DAK Non Fisik</th>
  ...
  foreach ($program as $key => $value) { 
    ...
    <tr>
      <td><?php echo $no_program ?></td>
       <td colspan="15" style="font-size:10px"><div><b><?php echo $value->nama_program ?></b></div></td>
     </tr>
    <?php 
    $no_kegiatan=0;
    ...
    <tr>
      <td><?php echo $no_program.'.'.$no_kegiatan ?></td>
       <td colspan="15" style="padding-left:1.5em" ><div class="nama_kegiatan"><b><?php echo $value_kegiatan->nama_kegiatan ?></b></div></td>
     </tr>
     <?php 
...
?>
 ...
 ?>
    ...
    <tr>
      <td colspan="16" style="font-size:12px"><div><b>Perhitungan Deviasi / Sub Kegiatan</b></div></td>
     
    </tr>
    <tr style="background: #f8b2b2;">
      <td colspan="14">Deviasi Diatas -10%</td>
      <td><center><?= $total_peringatan_dev_fisik_merah  ?></center></td>
      <td><center><?= $total_peringatan_dev_keu_merah  ?></center></td>
    </tr>
    <tr style="background: #fcf3cf;">
      <td colspan="14">Deviasi antara -5% sampai -10%</td>
