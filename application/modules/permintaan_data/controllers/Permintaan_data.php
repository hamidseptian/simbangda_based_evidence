...
class Permintaan_data extends MY_Controller
{
 ...
 public function simpanedit_permintaan_data(){
    ...
    public function simpan_upload_file()
    {
            ...
            $namafiledisimpan = $id_pengirim."-".date('Ymdhis');
    ...
    public function download_lampiran(){
        ...
        // $id_permintaan_data =1;
        // $file = 'Pengumuman_20251020032912.pdf';
        $nama_file = '/sbe_files_support/permintaan_data/'.$id_permintaan_data.'/lampiran/'.$file;
        ...
        $path = FCPATH . $nama_file; // path file asli
        $nama_download = $format.'.'.$file_ext; // nama file saat diunduh (custom)
    ...
    if (file_exists($path)) {
        ...
        $this->session->set_flashdata('pesan','<div class="alert alert-info">File lampiran '.$format.' tidak ditemukan</div>');
        redirect('permintaan_data/detail/'.sbe_crypt($id_permintaan_data));
    ...
    public function download_file(){
        ...
        // $id_permintaan_data =1;
        // $file = 'Pengumuman_20251020032912.pdf';
        $nama_file = '/sbe_files_support/permintaan_data/'.$id_permintaan_data.'/file/'.$file;
