...
class Target_realisasi_model extends CI_Model
{
	...
	public function all_kegiatan($id_instansi, $tahap, $tahun)
	{
	...
	public function total_paket($id_instansi, $kode_rekening_sub_kegiatan, $tahun)
	{
		$query  = $this->db->query("SELECT
	...
	public function total_paket_perjenis($id_instansi, $kode_rekening_sub_kegiatan, $jenis, $tahun)
	{
		$query  = $this->db->query("SELECT
										pp.id_paket_pekerjaan
									FROM
	...
	{
		return $this->db->query("SELECT SUM(pagu) AS pagu FROM v_sub_kegiatan_apbd WHERE id_instansi = '{$id_instansi}' and kode_tahap='$tahap' and tahun='$tahun'")->row()->pagu;
	}
	...
	public function persentase($kode_rekening_sub_kegiatan, $jenis_paket, $bulan, $tahun)
	{
		$query  = $this->db->query("SELECT
	...
	public function grafik($id_instansi, $tahap, $tahun)
	{
		...
		$query  = $this->db->query("SELECT * from grafik
									where id_instansi = '$id_instansi' 
									and kode_tahap = '$tahap'
									and tahun = '$tahun'
