	...
	<div class="card-body">
		<div class="row">
				...
				<div class="form-group">
					...
					<select name="kategori_laporan" id="kategori_laporan" class="form-control">
						...
						$kategori_laporan = [
							...
							// 'rfk_berdasarakan_kelompok_jenis_belanja'=>'Realisasi Fisik Dan Keuangan Berdasarkan Jenis Belanja',
			...
			<div class="col-md-2" id="f_bulan">
				...
				<div class="col-md-2" id="f_bulan">
				<div class="form-group">
					<label for="bulan"><strong>Data APBD Yang Ditampilkan</strong></label>
					<select name="data_apbd" id="data_apbd" class="form-control">
			...
			<div class="col-md-2" id="f_bulan">
				<div class="form-group">
					<label for="bulan"><strong>Fisik / Keuangan</strong></label>
					<select name="fisik_keuangan" id="fisik_keuangan" class="form-control">
			...
			<div class="col-md-2" id="f_bulan">
				<div class="form-group">
					<label for="bulan"><strong>Pilihan Batasan </strong></label>
					<select name="pilihan_batasan" id="pilihan_batasan" class="form-control">
						<option value="dibawah">Lebih Kecil Dari</option>
						<option value="diatas">Lebih Besar Dari</option>
			...
			<div class="col-md-2" id="f_bulan">
				<div class="form-group">
					<label for="bulan"><strong>Batasan</strong></label>
					<select name="batasan" id="batasan" class="form-control">
						<option></option>
						<?php for ($a = 1; $a <= 100; $a++) : ?>
