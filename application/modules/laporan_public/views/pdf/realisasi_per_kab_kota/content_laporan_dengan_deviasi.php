 ...
 <tbody>
  ...
  foreach ($skpd as $k => $v) { 
   ...
   <tr>
     ...
     <td class="rata_kanan"><?php echo number_format($target_keuangan) ; ?></td>
 ...
 <tfoot>
   <tr>
     <td colspan="2">Total</td>
      ...
      <td align="center"> <?php echo number_format($total_target_keuangan)  ?></td>
   ...
   <tr>
      <td colspan="11" style="font-size:11px"><div><b>Perhitungan Deviasi / SKPD</b></div></td>
    ...
    <tr style="background: #f8b2b2;">
      ...
      <td colspan="5"><center> <?= $total_peringatan_dev_keu_merah  ?>  </center></td>
    </tr>
    <tr style="background: #fcf3cf;">
      <td colspan="3">Deviasi antara -5% sampai -10%</td>
      <td colspan="3"><center> <?= $total_peringatan_dev_fisik_kuning  ?>  </center></td>
      <td colspan="5"><center> <?= $total_peringatan_dev_keu_kuning  ?>  </center></td>
    </tr>
    <tr style="background: #d5f5e3;">
      ...
      <td colspan="5"><center> <?= $total_peringatan_dev_keu_hijau  ?>  </center></td>
    </tr>
