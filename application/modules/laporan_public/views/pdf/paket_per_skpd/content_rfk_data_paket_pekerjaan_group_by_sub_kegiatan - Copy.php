...
<table class="font_laporan border">
  <thead class="header">
    ...
    <tr>
      ...
      <th colspan="8">RFK</th>
      <th colspan="4" rowspan="2">Terkontrak</th>
    </tr>
    <tr>
   ...
   <tbody>
     ...
     foreach ($sub_kegiatan_paket->result() as $key => $value_sk) { 
      ...
      $q_sub_kegiatan = $this->db->query("SELECT kode_rekening_sub_kegiatan, nama_sub_kegiatan, pagu, kode_tahap, tahun  from v_sub_kegiatan_apbd $where")->row_array();
    ...
    foreach ($paket->result_array() as $k_paket => $v_paket) {
      ...
      ?>
        ...
        <?php }else{ 
          $hitung_kontrak +=1;
          ?>
          <td><?php echo $v_paket['pelaksana'] ?></td>
  ...
  ?>
   ...
   <tfoot>
    <tr>
       ...
       <th colspan="8">-</th>
       <th colspan="4"><?php echo $hitung_kontrak ?> Terkontrak</th>
      </tr>
   </tfoot>
</table>
