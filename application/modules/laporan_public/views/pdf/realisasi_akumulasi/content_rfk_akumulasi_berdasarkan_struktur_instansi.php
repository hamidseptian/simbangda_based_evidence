...
$total_sisa_anggaran_semua = 0;
  ...
  foreach ($program as $key => $value) { 
    ...
    $kegiatan = $this->realisasi_akumulasi_model->get_kegiatan_berdasarkan_struktur_instansi($id_instansi, $value->kode_rekening_program, $tahun, $kode_tahap, $id_user_kpa, $id_user_pptk)->result(); ?>
    ...
    foreach ($kegiatan as $key => $value_kegiatan) {
      ...
      $no_kegiatan++;
      $no_sub_kegiatan = 0;
        $sub_kegiatan = $this->realisasi_akumulasi_model->get_sub_kegiatan_berdasarkan_struktur_instansi($id_instansi, $value_kegiatan->kode_rekening_kegiatan, $tahun, $kode_tahap, $id_user_kpa, $id_user_pptk);
    ?>
