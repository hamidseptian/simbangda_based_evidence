  ...
  foreach ($program as $key => $value) { 
    ...
    $kegiatan = $this->realisasi_akumulasi_model->get_kegiatan_berdasarkan_sumber_dana($id_instansi, $value->kode_rekening_program, $value->kode_bidang_urusan, $field_jenis_sumber_dana)->result(); ?>
    ...
    foreach ($kegiatan as $key => $value_kegiatan) {
      ...
      $no_kegiatan++;
      $no_sub_kegiatan = 0;
        $sub_kegiatan = $this->realisasi_akumulasi_model->get_sub_kegiatan_berdasarkan_sumber_dana($id_instansi, $value_kegiatan->kode_rekening_kegiatan, $value_kegiatan->kode_rekening_program, $value_kegiatan->kode_bidang_urusan, $field_jenis_sumber_dana );
    ?>
    ...
    $sisa_anggaran_kegiatan =0;
     ...
     foreach ($sub_kegiatan->result() as $key => $value_sk) {
      ...
      $total_pagu_sub_kegiatan_instansi +=$value_sk->pagu ;
          ...
          $q_pptk = $this->db->query("SELECT mu.full_name as pptk, mu2.full_name  as kpa from users_sub_kegiatan usk left join master_users mu on usk.id_user = mu.id_user and mu.id_kedudukan=3
            left join sub_instansi si on mu.id_sub_instansi = si.id_sub_instansi and si.status=1
            left join master_users  mu2 on si.id_kpa = mu2.id_sub_instansi and mu2.id_kedudukan=2
...
<table class="font_laporan border table">
 <thead class="header">
    ...
    if (in_array($field_jenis_sumber_dana, $jenis_sumber_dana_terkolom)) {
      $colspan_program_kegiatan = 16;
      
    }else{ 
       $colspan_program_kegiatan = 17;
       ?>
 ...
 <tbody>
  ...
  <tr style="background: #e8daef">
    ...
    <th align="left" colspan="<?php echo $colspan_program_kegiatan ?>"> <?php echo $v_program['nama_program'] ?></th>
    ...
    foreach ($v_program['data_kegiatan'] as $k_kegiatan => $v_kegiatan) { 
      ...
      ?>
       ...
       <tr style="background: #d6eaf8 ">
        ...
        <th align="left" colspan="<?php echo $colspan_program_kegiatan ?>"> <?php echo $v_kegiatan['nama_kegiatan'] ?></th>
    
      </tr>
<?php  
      foreach ($v_kegiatan['data_sub_kegiatan'] as $k_ski => $v_sub_kegiatan) { 

          $bobot_ski =( $v_sub_kegiatan['pagu_sub_kegiatan'] /$total_pagu_skpd)*100;
        ...
        ?>
          ...
          <tr>
            ...
            <td align="center"><?php echo round($bobot_ski,2);//round($bobot_ski,2) ?></td>
  ...
  <!-- <tr style="background: grey">
   ...
   <tr>
    <?php 
      ...
      $deviasi_fisik_total = round(($total_rft_ski - $total_tft_ski),2);
    ...
    <!-- <tr> <td colspan="14"><?php echo json_encode($program) ?> </td></tr> -->
</tfoot>
</table>
