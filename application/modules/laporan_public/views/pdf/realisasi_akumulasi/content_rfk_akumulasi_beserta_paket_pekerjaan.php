 ...
 $data_paket = $this->db->query("SELECT * from v_paket where id_instansi='$id_instansi' and tahun='$tahun' and kode_rekening_sub_kegiatan='$krsk'");
          ...
          $nilai_evidence = $this->db->query("SELECT sum(nilai)as rf FROM realisasi_fisik WHERE id_paket_pekerjaan = '$id_paket_pekerjaan' and bulan<='$bulan'")->row_array();
               $data_kumpul_paket = [
                ...
                'nilai_r'=>  $v_paket->jenis_paket=='RUTIN' ?  round($persen_realisasi_keuangan,2) : ($nilai_evidence['rf'] =='' ? 0 : $nilai_evidence['rf']),
...
rowspan="3"  width="30px"><?php echo $var ?></th> <th rowspan="2" colspan="5"
>Program, Kegiatan, Sub Kegiatan</th><!-- <th
rowspan="3" style="width:80px">Pagu Anggaran</th> --> 
<th colspan="3">Fisik</th> 
<th colspan="5">Keuangan </th> <?php if ($ope=='<=') { 
...
$colspan_deviasi_keuangan_semua = 5;
  ...
  <tr>
    ...
    <th style="width:75px">Jenis Paket</th>
      ...
      foreach ($v_kegiatan['data_sub_kegiatan'] as $k_ski => $v_sub_kegiatan) { 
        ...
        ?>
          ...
          <?php foreach ($v_sub_kegiatan['data_paket'] as $k_paket => $v_paket) { ?>
            ...
            <td align="center">-</td>
            <td align="center"> <?php echo round($v_paket['nilai_r'],2) ?></td>
            <td align="center">-</td>
            <td align="center">-</td>
            <td align="center">-</td>
            <td align="center">-</td>
...
<tfoot>
   ...
   <tr>
    <?php 
     ...
     ?>
     <td colspan="4" align="center"><b>Total / Pencapaian</b> <br> <?php echo $status_synch.'<br>';?></td>

     <th align="center"><?php echo number_format($total_pagu_sub_kegiatan_instansi) ?></th>
     <th align="center">
      <?php echo $banyak_paket ?> Paket <br>
      <?php echo $banyak_paket_rutin ?> Rutin <br> <?php echo $banyak_paket_swa ?> Swakelola <br> <?php echo $banyak_paket_pen ?> Penyedia
     </th>
     ...
     <th align="right"> <?php echo number_format($total_angka_target_keuangan) ?> </th>
     <th align="center" style=""><?php echo round($nilai_total_persen_target_keuangan,2) ?> </th>

     <th align="right"> <?php echo number_format($total_realisasi_keuangan) ?> </th>

     <th align="center" > <?php echo round($persen_realisasi_keuangan_total,2) ?> </th>
