...
$total_rft_ski = 0;
    ...
    $total_rft_ski_per_kegiatan=0;
     ...
     foreach ($sub_kegiatan->result() as $key => $value_sk) {
      ...
      $total_pagu_sub_kegiatan_instansi +=$value_sk->pagu ;
          ...
          $rut = $jenis_rutin > 0 ? ($persen_realisasi_keuangan * $jenis_rutin) : 0;
      ...
      ?>
       ...
       <?php 
          ...
          $bobot_ski_per_kegiatan = ($value_sk->pagu/$pagu_kegiatan)*100;
          ...
          $bobot_ski_per_program = ($value_sk->pagu/$pagu_program)*100;
  ...
  <?php 
        ...
        $sisa_anggaran_program += $sisa_anggaran_kegiatan;
          ...
          $persen_capaian_fisik_kegiatan  = ($tampilkan_persen_rf_kegiatan / $tampilkan_persen_tf_kegiatan) * 100 ; 
          $persen_capaian_keuangan_kegiatan  = ($tampilkan_persen_rk_kegiatan / $tampilkan_persen_tk_kegiatan) * 100 ; 
      ...
      $rft_program =$tampilkan_persen_rf_program * $bobot_program /100;
         ...
         $persen_capaian_fisik_program  = ($tampilkan_persen_rf_program / $tampilkan_persen_tf_program) * 100 ; 
          $persen_capaian_keuangan_program  = ($tampilkan_persen_rk_program / $tampilkan_persen_tk_program) * 100 ; 
...
<?php  
      ...
      foreach ($v_kegiatan['data_sub_kegiatan'] as $k_ski => $v_sub_kegiatan) { 
          ...
          $bobot_ski_per_kegiatan = $v_sub_kegiatan['pagu_sub_kegiatan'] / $v_kegiatan['pagu_kegiatan'] *100;
