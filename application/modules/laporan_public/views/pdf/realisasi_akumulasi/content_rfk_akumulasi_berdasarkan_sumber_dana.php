      ...
      ?>
       ...
       <?php 
         ...
         $data_kumpul_sub_kegiatan = [
          ...
          'pagu_sumber_dana'=> $value_sk->$jenis_sumber_dana ,
...
<table class="font_laporan border table">
 <thead class="header">
    ...
    <th rowspan="2" colspan="5" >Program, Kegiatan, Sub Kegiatan</th>
  ...
  <tr>
    ...
    <th style="width:80px">Pagu Sumber Dana</th>
...
$total_peringatan_dev_kegiatan_keu_hijau = 0;
  ...
  <tr style="background: #e8daef">
    ...
    <th>  <?php echo  $jenis_sumber_dana ?> </th>
...
<?php  
      foreach ($v_kegiatan['data_sub_kegiatan'] as $k_ski => $v_sub_kegiatan) { ?>
          <tr>
            ...
            <td> <?php echo number_format($v_sub_kegiatan['pagu_sumber_dana']) ?></td>
