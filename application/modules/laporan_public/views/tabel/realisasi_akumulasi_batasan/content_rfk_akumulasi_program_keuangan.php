...
<table class="font_laporan border table">
 <thead class="header">
    ...
    <th rowspan="2" colspan="3" >Data <?php echo $data_apbd ?></th>
...
$display_none = "style='display:none'";
   ...
   foreach ($kumpul_program as $k_program => $v_program) { 
    ...
    if ($pilihan_batasan=='dibawah') {
          if ($v_program['persen_rk_program'] <= $batasan) {
            $tanda_rf_program = "style='background: #d6eaf8'";
            $no++;
          }else{
            $tanda_rf_program = $display_none;
  ...
  <tr  <?php echo $tanda_rf_program ?>>
        ...
        <th align="center" <?php echo $tanda_rk_program ?>> <?php echo round($v_program['persen_rk_program'],2) ?></th>
