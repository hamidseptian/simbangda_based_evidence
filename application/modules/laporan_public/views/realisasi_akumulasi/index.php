...
<div class="mb-3 card">
	<div class="card-body">
		<div class="row">
					...
					<select name="kategori_laporan" id="kategori_laporan" class="form-control">
						...
						$kategori_laporan = [
							'rfk_akumulasi'=>'Realisasi Fisik Dan Keuangan Akumulasi',
								...
								$kategori_laporan = [
									'rfk_akumulasi'=>'Realisasi Fisik Dan Keuangan Akumulasi',
									'rfk_akumulasi_dengan_bobot'=>'Realisasi Fisik Dan Keuangan Akumulasi Dengan Bobot Fisik',
									'rfk_akumulasi_struktur_instansi'=>'Realisasi Fisik Dan Keuangan Akumulasi Berdasarkan Struktur Instansi',
									'rfk_akumulasi_instansi_pembantu'=>'Realisasi Fisik Dan Keuangan Akumulasi Berdasarkan Instansi Pembantu Teknis',
									'rfk_data_sumber_dana'=>'Sumber Dana Kegiatan SKPD',
									'rfk_berdasarkan_data_sumber_dana'=>'Realisasi Fisik Dan Keuangan Akumulasi berdasarkan Sumber Dana Kegiatan SKPD',
				...
				<div class="form-group">
					...
					<select name="id_opd" id="id_opd" class="form-control" >
						<?php if ($this->session->userdata('group_name') == "ADMIN" or $this->session->userdata('group_name') == "SUPER ADMIN") : ?>
							<option value="semua_opd" id="semua_opd">Semua OPD</option>
						<?php endif; ?>
			...
			<div class="col-md-2" id="f_instansi_pembantu" style="display:none">
				<div class="form-group">
					<label for="instansi_pembantu"><strong>Instansi Pembantu</strong></label>
					<select name="instansi_pembantu" id="instansi_pembantu" class="form-control" >
						<option></option>
						
					</select>
				</div>
			</div>
			<div class="col-md-2" id="f_kpa" style="display:none">
				<div class="form-group">
					<label for="kpa"><strong>KPA</strong></label>
					<select name="kpa" id="kpa" class="form-control" >
						<option></option>
						
					</select>
				</div>
			</div>
			<div class="col-md-2" id="f_pptk" style="display:none">
				<div class="form-group">
					<label for="pptk"><strong>PPTK</strong></label>
			...
			<div class="col-md-2" id="f_jenis_submer_dana" style="display:none">
				<div class="form-group">
					<label for="jenis_sumber_dana"><strong>Jenis Sumber Dana</strong></label>
					<select name="jenis_sumber_dana" id="jenis_sumber_dana" class="form-control" >
						...
						<?php 
						$jenis_sumber_dana	= $this->db->get('jenis_sumber_dana');
						foreach ($jenis_sumber_dana->result_array() as $k => $v) { ?>
