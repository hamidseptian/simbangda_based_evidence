		...
		<div class="row">
			<div class="col-md-6">
				...
				<div class="alert alert-info" id="caption">
					Silahkan pilih paket pekerjaan yang akan dibuatkan kontrak
				</div>
				<form id="form-register-kontrak">
							...
							<div class="input-group  mb-3">
								<input type="text" class="form-control" id="nama_paket" name="nama_paket" readonly="true" value="Pilih Paket Pekerjaan">
								<button type="button" class="btn btn-info" onclick="pilih_paket_pekerjaan()">Pilih Paket</button>
							</div>
				...
				<div class="form-group register-kontrak" style="display: none;">
					...
					<button class="btn btn-info" id="btn-register-kontrak" onclick="save_register_kontrak()" type="button">Register Kontrak</button>
					</div>
