                        ...
                        <div class="widget-chart-flex align-items-center">
                            <div>
                               ...
                               <a class="btn btn-info btn-xs" href="<?php echo base_url() ?>data_apbd/usulkan_data_apbd" data-toggle="tooltip" title="Usulkan Data APBD"><i class="fa fa-book"></i></a>
                                <?php if ($total_data_apbd==0) { ?>
                               <a class="btn btn-info btn-xs" href="#" data-toggle="tooltip" title="Copy Sub Kegiatan" onclick="pilih_copy_data_apbd()"><i class="fa fa-copy"></i></a>
                                <?php } ?>
