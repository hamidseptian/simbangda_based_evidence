		...
		<div class="row">
			<div class="col-md-6">
				...
				<form id="form-register-kontrak">
					<div class="form-row">
						<div class="col-md-12">
							<label for="id_paket_pekerjaan"><strong>Paket Pekerjaan Kontruksi</strong></label>
							<div class="input-group mb-3">
								<input type="hidden" id="id_pptk" name="id_pptk">
								<select name="id_paket_pekerjaan" id="id_paket_pekerjaan" class="form-control" onchange="tampil_register_kontrak(this.value)" style="width: 100%">
								</select>
							</div>
						</div>
					</div>
				...
				<div class="form-group register-kontrak" style="display: none;">
					...
					<button class="btn btn-info" id="btn-register-kontrak" onclick="save_register_kontrak()">Register Kontrak</button>
				</div>
			</div>
