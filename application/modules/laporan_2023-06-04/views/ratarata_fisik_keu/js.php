...
<script>
	...
	function show_laporan() {
		...
		if (nomenklatur=='') {
			...
			$('#tampil_pdf').show();
			$('#tampil_pdf').attr('src', baseUrl('laporan/pdf_laporan_ratarata_realisasi?filter=' + asisten + '&realisasi=' + realisasi + '&bulan=' + bulan +'&tahun=' + tahun +'&kategori_penampilan_data=' + kategori_laporan +'&tahap=' + tahap + '&nomenklatur=' + nomenklatur + '&kategori=' + kategori + '&perhitungan=' + perhitungan));
		}
