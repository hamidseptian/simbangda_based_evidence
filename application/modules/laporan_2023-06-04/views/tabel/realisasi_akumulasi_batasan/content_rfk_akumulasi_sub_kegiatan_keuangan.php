...
<?php 
    foreach ($v_program['data_kegiatan'] as $k_kegiatan => $v_kegiatan) { 
       ...
       foreach ($v_kegiatan['data_sub_kegiatan'] as $k_ski => $v_sub_kegiatan) { 
            ...
            if ($pilihan_batasan=='dibawah') {
              if ($v_sub_kegiatan['persen_rk_sub_kegiatan'] <= $batasan) {
                $tanda_rk_sub_kegiatan = "";
                $no++;
              }else{
                $tanda_rk_sub_kegiatan = $display_none;
      ...
      ?>
       ...
       <tr  <?php echo $tanda_rk_sub_kegiatan ?>>
        ...
        <th align="right"> <?php echo number_format($v_sub_kegiatan['nilai_rk_sub_kegiatan']) ?></th>
        <th align="center" <?php echo $tanda_rk_sub_kegiatan ?>> <?php echo round($v_sub_kegiatan['persen_rk_sub_kegiatan'],2) ?></th>
