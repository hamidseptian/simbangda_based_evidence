  ...
  foreach ($program as $key => $value) { 
    ...
    $kegiatan = $this->realisasi_akumulasi_model->get_kegiatan_berdasarkan_sumber_dana($id_instansi, $value->kode_rekening_program, $value->kode_bidang_urusan, $jenis_sumber_dana)->result(); ?>
    ...
    foreach ($kegiatan as $key => $value_kegiatan) {
      ...
      $no_kegiatan++;
      $no_sub_kegiatan = 0;
        $sub_kegiatan = $this->realisasi_akumulasi_model->get_sub_kegiatan_berdasarkan_sumber_dana($id_instansi, $value_kegiatan->kode_rekening_kegiatan, $value_kegiatan->kode_rekening_program, $value_kegiatan->kode_bidang_urusan, $jenis_sumber_dana );
    ?>
...
<tfoot>
  ...
  <!-- <tr style="background: grey">
   ...
   <tr>
      <td rowspan="2" colspan="3">Pencapaian khusus sumber dana <?php echo $jenis_sumber_dana ?></td>
   ...
   <tr>
    <?php 
      ...
      $deviasi_fisik_total = round(($total_tft_ski-$total_rft_ski),2);
  ...
  <tr style="background: #dac8c5 ">
   ...
   <tr style="background: aqua">
    <?php 
      ...
      $deviasi_fisik_total = $grafik['realisasi_fisik_akumulasi'] - $grafik['target_fisik_akumulasi'];
      $deviasi_keuangan_total = $grafik['realisasi_keuangan_akumulasi'] - $grafik['target_keuangan_akumulasi'];
     ...
     ?>
      <td colspan="3" >Pencapaian keluruhan pada OPD <br> Terakhir Synchronize <?php echo $grafik['last_update'] ?></td>
     <th align="center">Total / Pencapaian</th>

      <td align="right"><?php echo number_format($grafik['pagu_total']) ?></td>
      <th>-</th>
      <th>-</th>
      <th>-</th>
     
      <th colspan="2"><?php echo $grafik['target_fisik_akumulasi'] ?></th>
      <th colspan="2"><?php echo $grafik['realisasi_fisik_akumulasi'] ?></th>
      <th  style="background: red" align="center" style="<?php echo $warna_peringatan_deviasi_fisik_total ?>"><?php echo round($deviasi_fisik_total,2) ?></th>
      <th align="right"><?php echo number_format($grafik['rp_target_keuangan_akumulasi']) ?></th>
      <th><?php echo $grafik['target_keuangan_akumulasi'] ?></th>
      <th align="right"><?php echo number_format($grafik['rp_realisasi_keuangan_akumulasi']) ?></th>
      <th ><?php echo $grafik['realisasi_keuangan_akumulasi'] ?></th>
     <th  style="background: red" align="center" style="<?php echo $warna_peringatan_deviasi_keuangan_total ?>"> <?php echo $deviasi_keuangan_total ?> </th>
      <?php if ($ope=='<=') { ?>
       <th align="center"> - </th>
       <?php } ?>
