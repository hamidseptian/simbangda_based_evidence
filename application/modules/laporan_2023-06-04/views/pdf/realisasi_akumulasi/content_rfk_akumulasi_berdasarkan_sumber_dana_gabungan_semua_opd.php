...
//  ini_set("pcre.backtrack_limit", "3000000");
  ...
  foreach ($daftar_skpd as $k_skpd => $v_skpd) {
    ...
    foreach ($program as $key => $value) { 
      ...
      $kumpul_kegiatan = [];
      $no_kegiatan = 0;
      $kegiatan = $this->realisasi_akumulasi_model->get_kegiatan_berdasarkan_sumber_dana($id_skpd, $value->kode_rekening_program, $value->kode_bidang_urusan, $jenis_sumber_dana)->result(); 
      ...
      foreach ($kegiatan as $key => $value_kegiatan) {
        ...
        $no_sub_kegiatan = 0;
        $kumpul_sub_kegiatan = [];
        $sub_kegiatan = $this->realisasi_akumulasi_model->get_sub_kegiatan_berdasarkan_sumber_dana($id_skpd, $value_kegiatan->kode_rekening_kegiatan, $value_kegiatan->kode_rekening_program, $value_kegiatan->kode_bidang_urusan, $jenis_sumber_dana );
        ...
        foreach ($sub_kegiatan->result() as $key => $value_sk) {
         ...
         if ($total_paket != 0) {
          ...
          $bobot_ski = $value_sk->pagu/$v_skpd->pagu_total*100;
          ...
          $rft_ski = $total_realisasi_fisik*$bobot_ski/100 ; 
            ...
            $total_pagu_ski_skpd += $value_sk->pagu ; 
            $total_tf_ski_skpd += $target_fisik ; 
            $total_tf_ttb_ski_skpd += $tft_ski ; 
          ...
          $total_pagu_program +=1;//$total_pagu_kegiatan ; 
          $data_kegiatan = [
      ...
      $total_pagu_ski_skpd += $total_pagu_program; 
        $data_program = [
          ...
          'pagu_program'=>444,//$total_pagu_program
        ];
...
<table class="font_laporan border table">
 ...
 <tbody>
  ...
  <tr style="background: aqua" >
    ...
    <td colspan="18"><b><?php echo $v_skpd['nama_instansi'] ?></b></td>
  </tr>
  ...
  <?php foreach ($v_skpd['data_program'] as $k_program => $v_program) { ?>
   <tr style="background: #c6d1fa">
    ...
    <td colspan="18"><?php echo $v_program['nama_program'] ?></td>
  ...
  <?php foreach ($v_program['data_kegiatan'] as $k_kegiatan => $v_kegiatan) { ?>
   <tr style="background: #c6faf8">
    ...
    <td colspan="18"><?php echo $v_kegiatan['nama_kegiatan'] ?></td>
  </tr>
...
$total_tf_ttb += $v_sub_kegiatan['tf_ttb'] ; 
$total_rf += $v_sub_kegiatan['rf_persen'] ; 
$total_rf_ttb += $v_sub_kegiatan['rf_ttb'] ; 
...
$total_sisa_angaran += $v_sub_kegiatan['sisa_pagu'] ; 
   ...
   <tr>
    ...
    <td align="center"><?php echo round($v_sub_kegiatan['bobot'],2) ?></td>
    <td align="center"><?php echo round($v_sub_kegiatan['tf_persen'],2) ?></td>
    <td align="center"><?php echo round($v_sub_kegiatan['tf_ttb'],2) ?></td>
    <td align="center"><?php echo round($v_sub_kegiatan['rf_persen'],2) ?></td>
    <td align="center"><?php echo round($v_sub_kegiatan['rf_ttb'],2) ?></td>
...
$pencapaian_rk_persen = $v_skpd['total_rk_rp_ski_skpd'] / $v_skpd['total_pagu_ski_skpd'] * 100 ; 
  ...
  <tr style="background: grey">
    ...
    <th>-</th>
    <th>-</th>
    <th><?php echo round($v_skpd['total_tf_ski_skpd'],2) ?></th>
    <th><?php echo round($v_skpd['total_tf_ttb_ski_skpd'],2) ?></th>
    <th><?php echo round($v_skpd['total_rf_ski_skpd'],2) ?></th>
    <th><?php echo round($v_skpd['total_rf_ttb_ski_skpd'],2) ?></th>
    <th>-</th>
 ...
 <?php  } // end foreach ($kumpul_skpd as $k_skpd => $v_skpd) {
    ...
    $dev_fisik_total =  $total_rf_ttb - $total_tf_ttb ;
 ...
 <tfoot>
   ...
   <tr>
     ...
     <th>-</th>
     <th>-</th>
     <th><?php echo round($total_tf,2) ?></th>
     <th><?php echo round($total_tf_ttb,2) ?></th>
     <th><?php echo round($total_rf,2) ?></th>
   ...
   <tr>
     ...
     <th>-</th>
     <th>-</th>
     <th  colspan="2"><?php echo round($total_tf_ttb,2) ?></th>
     <th  colspan="2"><?php echo round($total_rf_ttb,2) ?></th>
