...
$data['id_user_pptk']=$id_user_pptk;
        ...
        elseif ($kategori_penampilan_laporan=='rfk_berdasarkan_data_sumber_dana') {
        	...
        	$judul_penampilan_laporan = "Laporan realisasi fisik dan keuangan berdasarkan Sumber Dana ".strtoupper($jenis_sumber_dana)." Per Sub Kegiatan<br>".$judul_laporan;
		    // $html =  $this->load->view('laporan/pdf/realisasi_akumulasi/content_rfk_akumulasi_berdasarkan_sumber_dana', $data, true);
		    $html =  $this->load->view('laporan/pdf/realisasi_akumulasi/content_rfk_akumulasi_berdasarkan_sumber_dana_gabungan_semua_opd', $data, true);
        	}else{
        	$judul_penampilan_laporan = "Laporan realisasi fisik dan keuangan berdasarkan Sumber Dana ".strtoupper($jenis_sumber_dana)." Per Sub Kegiatan<br>".$judul_laporan;
		    // $html =  $this->load->view('laporan/pdf/realisasi_akumulasi/content_rfk_akumulasi_berdasarkan_sumber_dana', $data, true);
