...
function input_realisasi(jenis, kode_rekening_sub_kegiatan, kode_kegiatan, kode_program, kode_bidang_urusan, pagu)
	{	
 ...
 bt_bbk = `<a href="#" id="r-bt_bbk" jenis="${jenis}" kode_rekening_sub_kegiatan="${kode_rekening_sub_kegiatan}" kode_kegiatan="${kode_kegiatan}" kode_program="${kode_program}" kode_bidang_urusan="${kode_bidang_urusan}" pagu="${pagu}" pk="${v.id_realisasi}" class="edit" data-type="text" onclick="edit_realisasi_keuangan(this, ${v.bulan})"> ${convert_to_rupiah(v.bt_bbk)}</a>`;
    ...
    function edit_realisasi_keuangan(x, bulan) {
        ...
        $(x).editable({
            ...
            success: function(c) {
                input_realisasi(jenis,kode_rekening_sub_kegiatan,kode_kegiatan,kode_program,kode_bidang_urusan,pagu);
                show_sub_kegiatan_apbd_instansi_gabungan();
            },
        });
    }
