               ...
               <div class="form-group">
                    <table class="table">
                        ...
                        <tr>
                            <td>Pagu Terpakai</td>
                            <td>:</td>
                            <td class="pagu_anggaran_terpakai"></td>
                        </tr>
                        <tr>
                            <td>Pagu Tersedia</td>
                            <td>:</td>
                ...
                <form id="formMasterPaket">
                	<input type="hidden" name="id_paket_pekerjaan_sebelumnya" id="id_paket_pekerjaan_sebelumnya">
                    ...
                    <div class="col-md-12">
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                ...
                                if ($aktif==0) { ?>
                                    <button class="btn btn-outline-danger" type="button" onclick="Swal.fire('Terkunci','<?php echo $pesan ?>','error')">Tambah</button>
                                <?php }else{ ?>
