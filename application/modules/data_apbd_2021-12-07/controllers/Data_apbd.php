...
public function sync_eplanning()
    ...
    public function kegiatan_apbd_instansi()
    {
        if (!$this->input->is_ajax_request()) {
            ...
            $where          = ['id_instansi' => id_instansi(), 'kode_rekening_program' => $kode_program, 'kode_tahap'=>tahapan_apbd()];
    ...
    public function update_target_fisik($kode_rekening_sub_kegiatan)
    {
        ...
        $target_lalu    = $this->db->get_where('target_apbd', ['kode_rekening_sub_kegiatan' => $kode_rekening_sub_kegiatan, 'bulan' => $target['bulan'] - 1, 'kode_tahap' => tahapan_apbd(), 'id_instansi'=>id_instansi()])->row_array();
        ...
        if ($nilai >= 100) {
            for ($i = $target['bulan']; $i <= 12; $i++) {
                $this->db->update('target_apbd', ['target_fisik' => 100], ['kode_rekening_sub_kegiatan' => $kode_rekening_sub_kegiatan, 'bulan' => $i,  'id_instansi'=>id_instansi()]);
            }
        } else {
    ...
    public function update_target_keuangan($kode_rekening_sub_kegiatan)
    {
        ...
        $tahap = tahapan_apbd();
        $id_instansi = id_instansi();
        $qski = $this->db->query("SELECT * from v_sub_kegiatan_apbd where kode_tahap='$tahap' and id_instansi='$id_instansi' and kode_rekening_sub_kegiatan='$kode_rekening_sub_kegiatan'")->row();
        ...
        if ($nilai >= $pagu) {
            for ($i = $target['bulan']; $i <= 12; $i++) {
                $this->db->update('target_apbd', ['target_keuangan' => $pagu], ['kode_rekening_sub_kegiatan' => $kode_rekening_sub_kegiatan, 'bulan' => $i, 'id_instansi'=>id_instansi()]);
            }
        } else {
            $this->db->update('target_apbd', ['target_keuangan' => $nilai], ['id_target_apbd' => $id_target_apbd ,'id_instansi'=>id_instansi()]);
        }
    }
    ...
    public function sub_kegiatan_apbd_instansi()
    {
        if (!$this->input->is_ajax_request()) {
            ...
            $where          = ['id_instansi' => id_instansi(), 'kode_rekening_kegiatan' => $kode_kegiatan, 'kode_tahap'=>tahapan_apbd()];
            ...
            foreach ($list as $lists) {
                ...
                $row[]  = $lists->nama_sub_kegiatan;
                 $pagu   = $lists->pagu =='' ? 0 : $lists->pagu;
                $row[]  =  '<span style="float:right">'.number_format($pagu,0,'','.').'</span>';
                $onclick = "hapus_sub_kegiatan_instansi('".$lists->kode_rekening_sub_kegiatan."','".$lists->kode_rekening_kegiatan."', '".$lists->kode_rekening_program."','instansi')";
                $onclick2 = "input_anggaran('".$lists->kode_rekening_sub_kegiatan."','".$lists->kode_rekening_kegiatan."', '".$lists->kode_rekening_program."','".tahapan_apbd()."','".$lists->kode_bidang_urusan."','instansi')";

               $onclick3 = "get_target('".$lists->kode_rekening_sub_kegiatan."','".$lists->kode_rekening_kegiatan."', '".$lists->kode_rekening_program."','".tahapan_apbd()."','".$lists->kode_bidang_urusan."','".$lists->pagu."')";

             $onclick4 = "get_sumber_dana('".$lists->kode_rekening_sub_kegiatan."','".$lists->kode_rekening_kegiatan."', '".$lists->kode_rekening_program."','".tahapan_apbd()."','".$lists->kode_bidang_urusan."','".$lists->pagu."')";
    ...
    public function sub_kegiatan_apbd_instansi_gabungan($input_by)
    {
        if (!$this->input->is_ajax_request()) {
            ...
            $kode_kegiatan  = $this->input->post('kode_kegiatan');
            if ($input_by=='excel') {
                $where          = ['kode_tahap'=>$tahap, 'id_instansi' => id_instansi(), 'input_by'=>'Export Excel'];
            }
            else if ($input_by=='api') {
                $where          = ['kode_tahap'=>$tahap, 'id_instansi' => id_instansi(), 'input_by'=>'Web Service'];
            }else{
            ...
            foreach ($list as $lists) {
                ...
                $row[]  =  '<span style="float:right">'.number_format($pagu,0,'','.').'</span>';
                $row[]  = $lists->input_by;
                $onclick = "hapus_sub_kegiatan_instansi('".$lists->kode_rekening_sub_kegiatan."','".$lists->kode_rekening_kegiatan."', '".$lists->kode_rekening_program."','gabungan')";
                $onclick2 = "input_anggaran('".$lists->kode_rekening_sub_kegiatan."','".$lists->kode_rekening_kegiatan."', '".$lists->kode_rekening_program."','".tahapan_apbd()."','".$lists->kode_bidang_urusan."','gabungan')";
    ...
    public function permasalahan_sub_kegiatan_apbd_instansi($id_opd)
    {
        if (!$this->input->is_ajax_request()) {
            ...
            foreach ($list as $lists) {
                ...
                $kode_rekening_program = $lists->kode_rekening_program;
                $kode_rekening_kegiatan = $lists->kode_rekening_kegiatan;
                $permasalahan  = $this->db->query("SELECT * from permasalahan_sub_kegiatan where kode_sub_kegiatan = '$krsk' and id_instansi='$id_instansi'");

                $solusi  = $this->db->query("SELECT id_solusi_permasalahan_sub_kegiatan, id_instansi, solusi, solusi_by from solusi_permasalahan_sub_kegiatan where kode_sub_kegiatan = '$krsk' and id_instansi='$id_instansi'");
                ...
                foreach ($permasalahan->result() as $k_masalah => $v_masalah) {
                    $show_masalah = "edit_permasalahan('".$lists->kode_rekening_sub_kegiatan."','".$lists->kode_rekening_kegiatan."', '".$lists->kode_rekening_program."','".tahapan_apbd()."','".$lists->kode_bidang_urusan."','".$v_masalah->id_permasalahan_sub_kegiatan."')";
                ...
                if ($permasalahan->num_rows()>0) {
                 ...
                 $onclick = "input_permasalahan('".$lists->kode_rekening_sub_kegiatan."','".$lists->kode_rekening_kegiatan."', '".$lists->kode_rekening_program."','".tahapan_apbd()."','".$lists->kode_bidang_urusan."')";
                $tombol_tambah_masalah = '<button class="btn btn-outline-info btn-xs"  title="Input permasalahan pad sub  kegiatan '.$lists->nama_sub_kegiatan.'"  onclick="'.$onclick.'"><i class="fas fa-plus"></i></button>';
                 ...
                 $onclick2 = "input_solusi_permasalahan('".$lists->kode_rekening_sub_kegiatan."','".$lists->kode_rekening_kegiatan."', '".$lists->kode_rekening_program."','".tahapan_apbd()."','".$lists->kode_bidang_urusan."','".sbe_crypt($lists->id_instansi, 'E')."')";
    ...
    public function show_pilihan_sub_kegiatan_apbd()
    {
        if (!$this->input->is_ajax_request()) {
            ...
            $where          = ['kode_tahap'=>$tahap, 'id_instansi' => id_instansi(), 'kategori'=>'Sub Kegiatan SKPD'];
            $column_order   = ['', 'nama_sub_kegiatan'];
            $column_search  = ['nama_sub_kegiatan','kode_rekening_sub_kegiatan'];
            $order          = ['nama_sub_kegiatan' => 'ASC'];
            $list           = $this->datatables_model->get_datatables('v_sub_kegiatan_apbd', $column_order, $column_search, $order, $where);
 ...
 public function get_target()
    {
        if (!$this->input->is_ajax_request()) {
            ...
            $subkeg                 = $this->db->query("SELECT nama_sub_kegiatan, kategori, jenis_sub_kegiatan, keterangan from v_sub_kegiatan_apbd where kode_rekening_sub_kegiatan='$kode_rekening_sub_kegiatan' and kode_tahap='$tahap' and id_instansi='$id_instansi'")->row();
        ...
        if (!$this->input->is_ajax_request()) {
            ...
            foreach ($list as $lists) {
                ...
                if ($sub_kegiatan_instansi>0) {
                    $onclick = "hapus_sub_kegiatan_instansi('".$lists->kode_sub_kegiatan."','".$lists->kode_kegiatan."', '".$lists->kode_program."','all')";
                ...
                $row[]     = '<button class="'.$btn.'" onclick="'.$onclick.'"><i class="'.$fa.'"></i></button>';
 ...
 public function hapus_all_apbd_instansi()
    ...
    public function hapus_sub_kegiatan_instansi()
    {
        if (!$this->input->is_ajax_request()) {
            ...
            $where      = ['kode_sub_kegiatan' => $kode_sub_kegiatan, 'id_instansi'=>id_instansi(), 'kode_kegiatan'=>$kode_kegiatan, 'kode_program'=>$kode_program, 'kode_tahap'=>tahapan_apbd()];
            $wheretarget      = ['kode_rekening_sub_kegiatan' => $kode_sub_kegiatan, 'id_instansi'=>id_instansi(), 'kode_tahap'=>tahapan_apbd(),  'kode_rekening_kegiatan'=>$kode_kegiatan, 'kode_rekening_program'=>$kode_program];
            ...
            if ($sub_kegiatan->num_rows() > 0) {
                ...
                $wherepaket =  ['kode_rekening_sub_kegiatan' => $kode_sub_kegiatan, 'id_instansi'=>id_instansi(), 'kode_rekening_kegiatan'=>$kode_kegiatan, 'kode_rekening_program'=>$kode_program, 'kode_tahap'=>tahapan_apbd()];
                $paket = $this->db->get_where('paket_pekerjaan', $wherepaket);
                $userpptk = $this->db->get_where('users_sub_kegiatan', $wherepaket);
                if ($paket->num_rows()>0) {
                ...
                if ($userpptk->num_rows()>0) {
                    foreach ($userpptk->result() as $key => $value) {
                        $delete_pptk =   $this->db->delete('users_sub_kegiatan', $wherepaket);
                    }
                }
    ...
    public function tambah_sub_kegiatan_instansi()
    {
        if (!$this->input->is_ajax_request()) {
            ...
            $where      = ['kode_sub_kegiatan' => $kode_sub_kegiatan, 'id_instansi'=>id_instansi(), 'kode_kegiatan'=>$kode_kegiatan, 'kode_program'=>$kode_program];
            $sub_kegiatan    = $this->db->get_where('sub_kegiatan_instansi', $where);
            $data_sub_kegiatan = $sub_kegiatan->row_array();
            $s_kode_program= $data_sub_kegiatan[''];
    ...
    public function dt_usulan_program()
    {
        if (!$this->input->is_ajax_request()) {
            ...
            foreach ($list as $lists) {
                ...
                $status         = ["Pengusulan","Ditolak Admin","Disetujui Admin"];
