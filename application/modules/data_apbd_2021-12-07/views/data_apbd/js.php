...
<script>
	...
	$(document).ready(function()
	{
	   ...
	   <?php } ?>
	   	show_permasalahan_sub_kegiatan_apbd(id_instansi, controller);
	   	show_program_all();
		showAutoCurrency();
	...
	function input_permasalahan(kode_rekening_sub_kegiatan, kode_kegiatan, kode_program, tahap, kode_bidang_urusan)
	{
	...
	function input_solusi_permasalahan(kode_rekening_sub_kegiatan, kode_kegiatan, kode_program, tahap, kode_bidang_urusan, id_instansi)
	{
	...
	function edit_permasalahan(kode_rekening_sub_kegiatan, kode_kegiatan, kode_program, tahap, kode_bidang_urusan, id_permasalahan)
	{
...
function get_target(kode_rekening_sub_kegiatan, kode_kegiatan, kode_program, tahap, kode_bidang_urusan, pagu)
	...
	function get_sumber_dana(kode_rekening_sub_kegiatan, kode_kegiatan, kode_program, tahap, kode_bidang_urusan, pagu) {
...
function show_permasalahan_sub_kegiatan_apbd(id_instansi, controller)
	{
...
function print_semua_permasalahan() {
	$('#modal_laporan_semua_permasalahan').modal('show');
		...
		$('#tampil_pdf_print_permasalahan').attr('src', baseUrl('laporan/pdf_rekap_laporan_permasalahan_sub_kegiatan') +  '#view=FitH');
		// 	}
		// }
	}
