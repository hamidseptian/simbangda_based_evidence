...
<script>
    ...
    title: {
        text: 'Perbandingan Pagu Dan Realisasi Berdasarkan Jenis Belanja'
    },
    subtitle: {
        text: ''
    },
    ...
    title: {
        text: 'Perbandingan Pagu Dan Realisasi Per Kelompok Jenis Belanja'
    },
    // subtitle: {
    ...
    series: [
    {
        ...
        yAxis: 1,
        data: [
			<?php echo $persen_rk_bo_bp; ?>,
			<?php echo $persen_rk_bo_bbj; ?>,
			<?php echo $persen_rk_bo_bs; ?>,
			<?php echo $persen_rk_bo_bh; ?>,
			<?php echo $persen_rk_bm_bmt; ?>,
			<?php echo $persen_rk_bm_bmpm; ?>,
			<?php echo $persen_rk_bm_bmgb; ?>,
			<?php echo $persen_rk_bm_bmjji; ?>,
			<?php echo $persen_rk_bm_bmatl; ?>,
			<?php echo $persen_rk_btt; ?>,
			<?php echo $persen_rk_bt_bbh; ?>,
			<?php echo $persen_rk_bt_bbk; ?>,
        ],
        tooltip: {
            valueSuffix: '%'
        }
    ...
    title: {
        text: 'Target Dan Realisasi Fisik Keuangan'
    },
    // subtitle: {
    //     text: 'Source: WorldClimate.com'
    // },
