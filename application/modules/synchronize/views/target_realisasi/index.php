                                	...
                                	<div class="col-md-12" id="synchronize_all">
                                		<div class="btn-group btn-block">
                                            <?php if (kunci_synch()['synchronize']==1) { ?>
    							                <button class="btn btn-outline-info btn-sm" onclick="sync_all()" id="tombol_sync_all">Synchronize Semua SKPD</button>   
                                            <?php }else{ ?>
                                                <button class="btn btn-outline-danger btn-sm" onclick="Swal.fire('Terkunci','<?php echo kunci_synch()['pesan'] ?>','error')" id="tombol_sync_all">Synchronize Semua SKPD</button>   

                                            <?php } ?>
                                                <button class="btn btn-outline-info btn-sm" onclick="perbandingan_grafik_2_tahun_terakhir_asisten('Akumulasi','Semua')">Rata Rata Semua OPD</button>   
                                                <button class="btn btn-outline-info btn-sm" onclick="perbandingan_grafik_2_tahun_terakhir_asisten('Akumulasi','1')">Rata Rata Asisten 1</button>   
                                                <button class="btn btn-outline-info btn-sm"   onclick="perbandingan_grafik_2_tahun_terakhir_asisten('Akumulasi','2')" >Rata Rata Asisten 2</button>   
                                                <button class="btn btn-outline-info btn-sm"   onclick="perbandingan_grafik_2_tahun_terakhir_asisten('Akumulasi','3')" >Rata Rata Asisten 3</button>   
							            </div>
	    ...
	    <div class="col-lg-12 col-xl-12">
	        <div class="main-card mb-3 card">
	            <div class="card-body">
	                ...
	                <table class="mb-0 table table-bordered table-hover table-striped" width="100%">
	                    <thead>
	                        <tr>
	                            <th width="1%">No</th>
