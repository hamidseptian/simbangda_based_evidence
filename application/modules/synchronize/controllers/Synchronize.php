...
return $kumpul_realisasi_keuangan_ratarata;
    ...
    public function synch_dashboard_pembangunan($author, $id_opd){
        // ini_set('max_execution_time', 300);

        $curl = curl_init();
        $url = 'https://admin-dashboard.sumbarprov.go.id/api/simbangda/integration?author=Offline_'.$author.'&idopd=91';
        ...
        curl_setopt_array($curl, array(
            ...
            CURLOPT_HTTPHEADER => array(
                ...
                "App-Key: gR@1=X-&1^0YQb8H`4Y(^&fTiAYUsfX0w<N*N'?~U0#il8Zk~'i2I_])>iWA5]e"
            ),
        ));
