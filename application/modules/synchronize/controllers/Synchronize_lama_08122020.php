...
class Synchronize extends MY_Controller
{
    ...
    public function sync()
    {
        ...
        $target_fisik[] = $t_fisik_jan;
        $target_fisik[] = $t_fisik_feb;
        $target_fisik[] = $t_fisik_mar;
        $target_fisik[] = $t_fisik_apr;
        $target_fisik[] = $t_fisik_mei;
        $target_fisik[] = $t_fisik_jun;
        $target_fisik[] = $t_fisik_jul;
        $target_fisik[] = $t_fisik_agu;
        $target_fisik[] = $t_fisik_sep;
        $target_fisik[] = $t_fisik_okt;
        $target_fisik[] = $t_fisik_nov;
        $target_fisik[] = $t_fisik_des;

        $target_keuangan[] = $t_keu_jan;
        $target_keuangan[] = $t_keu_feb;
        $target_keuangan[] = $t_keu_mar;
        $target_keuangan[] = $t_keu_apr;
        $target_keuangan[] = $t_keu_mei;
        $target_keuangan[] = $t_keu_jun;
        $target_keuangan[] = $t_keu_jul;
        $target_keuangan[] = $t_keu_agu;
        $target_keuangan[] = $t_keu_sep;
        $target_keuangan[] = $t_keu_okt;
        $target_keuangan[] = $t_keu_nov;
        $target_keuangan[] = $t_keu_des;
