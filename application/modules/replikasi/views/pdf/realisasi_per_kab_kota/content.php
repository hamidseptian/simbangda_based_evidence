...
<table class="font_laporan border">
 <thead class="header">
    ...
    <th rowspan="4"  width="185px">SKPD</th>
  ...
  foreach ($skpd as $k => $v) { 
   ...
   <tr>
     ...
     <td class="rata_kanan"><?php echo number_format($pagu_total); ?></td>
      <td class="rata_kanan"><?php echo $tampil_nilai_rk_instansi_bo_rf; ?></td>
     ...
     <td class="rata_kanan"><?php echo $tampil_nilai_rk_instansi_bm_rf; ?></td>
     ...
     <td class="rata_kanan"><?php echo $tampil_nilai_rk_instansi_btt_rf; ?></td>
     ...
     <td class="rata_kanan"><?php echo $tampil_nilai_rk_instansi_bt_rf; ?></td>
     ...
     <td class="rata_kanan"><?php echo $total_rf_instansi; ?></td>
 ...
 <tfoot>
   <tr>
     <td colspan="2">Total</td>
      ...
      <td class="rata_kanan"> <?php echo round($ratarata_realisasi_bo_rf,2) ; ?> </td>
      ...
      <td class="rata_kanan"> <?php echo round($ratarata_realisasi_bm_rf,2) ; ?> </td>
      ...
      <td class="rata_kanan"> <?php echo round($ratarata_realisasi_btt_rf,2) ; ?> </td>
      ...
      <td class="rata_kanan"> <?php echo round($ratarata_realisasi_bt_rf,2) ; ?> </td>
