...
<table class="font_laporan border">
 <thead class="header">
    ...
    <th rowspan="4"  width="185px">KABUPATEN / KOTA</th>
    <th rowspan="4" width="85px">Belanja Operasi</th>
    <th rowspan="4" width="85px">Belanja Modal</th>
    <th rowspan="4" width="85px">Belanja Tidak Terduga</th>
    <th rowspan="4" width="85px">Belanja Transfer</th>
    <th rowspan="4" width="85px">Pagu Total</th>
    <th colspan="12">Realisasi</th>
    <th colspan="3" rowspan="2">Total Realisasi</th>
  </tr>
  <tr>
    <th colspan="3">Belanja Operasi</th>
    <th colspan="3">Belanja Modal</th>
    <th colspan="3">Belanja Tidak Terduga</th>
    <th colspan="3">Belanja Transfer</th>
  </tr>
    <tr>
  <?php for ($i=0; $i < 5; $i++) {  ?>
      <th rowspan="2" width="10px">Fisik (%)</th>
 ...
 <tbody>
  ...
  foreach ($list_kota as $k => $v) { 
    $id_kota = $v->id_kota;
    $pagu = $model_realisasi_gabungan->pagu_kota($id_kota, $tahap);
    ...
    $no++; 
              ...
              $realisasi_dipilih = $model_realisasi_gabungan->cek_realisasi_dipilih($tahap, $id_kota)->row_array();
  ...
  $realisasi_bo = $model_realisasi_gabungan->total_realisasi_perjenis($bulan, $tahap, $id_kota, 'realisasikan_bo')->row_array()['realisasi_bo'];
  $realisasi_bm = $model_realisasi_gabungan->total_realisasi_perjenis($bulan, $tahap, $id_kota, 'realisasikan_bm')->row_array()['realisasi_bm'];
  $realisasi_btt = $model_realisasi_gabungan->total_realisasi_perjenis($bulan, $tahap, $id_kota, 'realisasikan_btt')->row_array()['realisasi_btt'];
  $realisasi_bt = $model_realisasi_gabungan->total_realisasi_perjenis($bulan, $tahap, $id_kota, 'realisasikan_bt')->row_array()['realisasi_bt'];
  // fusuk
  $realisasi_bo_rf = $model_realisasi_gabungan->total_realisasi_perjenis($bulan, $tahap, $id_kota, 'realisasikan_bo')->row_array()['realisasi_bo_rf'];
  $realisasi_bm_rf = $model_realisasi_gabungan->total_realisasi_perjenis($bulan, $tahap, $id_kota, 'realisasikan_bm')->row_array()['realisasi_bm_rf'];
  $realisasi_btt_rf = $model_realisasi_gabungan->total_realisasi_perjenis($bulan, $tahap, $id_kota, 'realisasikan_btt')->row_array()['realisasi_btt_rf'];
  $realisasi_bt_rf = $model_realisasi_gabungan->total_realisasi_perjenis($bulan, $tahap, $id_kota, 'realisasikan_bt')->row_array()['realisasi_bt_rf'];


  $pembagi_bo  = $model_realisasi_gabungan->banyak_realisasikan($tahap, $id_kota, 'realisasikan_bo')->row_array()['banyak_realisasikan_bo'];
  $pembagi_bm  = $model_realisasi_gabungan->banyak_realisasikan($tahap, $id_kota, 'realisasikan_bm')->row_array()['banyak_realisasikan_bm'];
  $pembagi_btt  = $model_realisasi_gabungan->banyak_realisasikan($tahap, $id_kota, 'realisasikan_btt')->row_array()['banyak_realisasikan_btt'];
  $pembagi_bt  = $model_realisasi_gabungan->banyak_realisasikan($tahap, $id_kota, 'realisasikan_bt')->row_array()['banyak_realisasikan_bt'];
...
$total_rf_bt_semua += $jumlah_realisasi_bt_rf;
  ...
  $nilai_rf_kota_ratarata = $nilai_rf_total > 0 ? $persen_rf_total : 0 ;
  ...
  $show_persen_rk_total = $persen_rk_total >0 ? $persen_rk_total : 0;
   ...
   <tr> 
    <td><?php echo $no ?></td>
      ...
      <td class="rata_kanan"><?php echo $tampil_nilai_rk_kota_bo_rf; ?></td>
      ...
      <td class="rata_kanan"><?php echo $tampil_nilai_rk_kota_bm_rf; ?></td>
      ...
      <td class="rata_kanan"><?php echo $tampil_nilai_rk_kota_btt_rf; ?></td>
      ...
      <td class="rata_kanan"><?php echo $tampil_nilai_rk_kota_bt_rf; ?></td>
...
$show_total_rf_semuanya = $total_rf_semuannya / 4;
 ...
 <tfoot>
   <tr>
       ...
       <td class="rata_kanan"> <?php echo round($show_total_bo_rf_semua,2) ?> </td> 
       ...
       <td class="rata_kanan"> <?php echo round($show_total_bm_rf_semua,2) ?> </td> 
       ...
       <td class="rata_kanan"> <?php echo round($show_total_btt_rf_semua,2) ?> </td> 
       ...
       <td class="rata_kanan"> <?php echo round($show_total_bt_rf_semua,2) ?> </td> 
