            ...
            <div class="widget-chart widget-chart2 text-left mb-3 card-btm-border card-shadow-success border-success card">
                <div class="widget-chat-wrapper-outer">
                    <div class="widget-chart-content">
                        <div class="widget-title opacity-5 text-uppercase"><?php echo $nama_instansi ?> </div>
                        <div class="widget-numbers mt-2 fsize-4 mb-0 w-100">
                            <div class="widget-chart-flex align-items-center">
                                <div>
                                   
                                  
                                   <button class="btn btn-info" onclick="show_laporan('<?php echo sbe_crypt($id_instansi, 'E'); ?>')" data-toggle="tooltip" title="Permasalahan pada pelaksanaan Sub Kegiatan">Lihat laporan realisasi akumulasi hingga bulan <?php echo    bulan_global(bulan_aktif()) ?></button>
                                   <button class="btn btn-info" onclick="print_semua_permasalahan()" data-toggle="tooltip" title="Print semua data permasalahan pada pelaksanaan Sub Kegiatan">Print semua data permasalahan</button>
