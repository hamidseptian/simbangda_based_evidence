    ...
    <div class="row">
         <div class="col-lg-12 col-xl-4">
            <div class="main-card mb-3 card">
                <div class="card-body">
                    <h5  class="card-title">Token Anda : </h5>
                    <input type="text" readonly class="form-control" id="token"> <br>
                    <button class="btn btn-info" type="button" onclick="get_token()">Get Token</button> <br> <br>
                   
                </div>
            </div>
        </div>
        <div class="col-lg-12 col-xl-8" id="show_sync" style="display: none">
            <div class="main-card mb-3 card">
                <div class="card-body">
                    ...
                    <table class="mb-0 table table-hover">
                        ...
                        <tbody>
                            <tr>
                                <th scope="row">1</th>
                                <td>Master Instansi</td>
                                <td id="jumlah_instansi"></td>
                                <td>
                                    <button class="btn btn-primary btn-sm" id="master_instansi" onclick="sync('master_instansi')">
                            ...
                            <tr>
                                <th scope="row">2</th>
                                <td>Master Bidang Urusan</td>
                                <td id="jumlah_bidang_urusan"></td>
                                <td>
                                    <button class="btn btn-primary btn-sm" id="master_bidang_urusan" onclick="sync('master_bidang_urusan')">
                                        <i class="pe-7s-science btn-icon-wrapper"> </i>
                                    </button>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <th scope="row">5</th>
                                <td>Master Sub Kegiatan</td>
                                <td id="jumlah_sub_kegiatan"></td>
                                <td>
                                    <button class="btn btn-primary btn-sm" id="master_sub_kegiatan" onclick="sync('master_sub_kegiatan')">
                                        <i class="pe-7s-science btn-icon-wrapper"> </i>
                                    </button>
                                </td>
                            </tr>
