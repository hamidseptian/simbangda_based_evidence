...
function update_master_program() {
	...
	function pilih_dan_alihkan_data_apbd(){
		...
		Swal.fire({
		  ...
		  footer : `<button type="button" onclick="setting_apbd()"  class="btn btn-info btn-sm" style="margin-right : 10px">Pilih Data APBD Sub Kegiatan Baru</button> <a href="`+ baseUrl(`data_apbd/pengalihan_tahapan_apbd_ski/`)+`"class="btn btn-info btn-sm">Alihkan Sub Kegiatan APBD Awal Ke APBD Parubahan</a>`,
		  // showCloseButton: false,
		  // showCancelButton: false,
		  showConfirmButton: false,
		  // focusConfirm: false,
