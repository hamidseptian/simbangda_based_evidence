...
class Data_apbd_model extends CI_Model
{
	...
	public function save_anggaran_sub_kegiatan_pergeseran()
	{
		...
		$data = [
			...
			'bt_bbh'				=> $post['bt_bbh'],
			'bt_bbk'				=> $post['bt_bbk'],
			'pergeseran_ke'				=> $post['pergeseran_ke'],
		...
		$this->db->insert('anggaran_sub_kegiatan_pergeseran', $data);
	}
	...
	public function saveedit_anggaran_sub_kegiatan_pergeseran($where)
	{
		$post = $this->input->post();
		$r_bo = $post['bo_bp'] + $post['bo_bbj'] + $post['bo_bs'] + $post['bo_bh'];
		$r_bm = $post['bm_bmt'] + $post['bm_bmpm'] + $post['bm_bmgb'] + $post['bm_bmjji'] + $post['bm_bmatl'];
		...
		$this->db->update('anggaran_sub_kegiatan_pergeseran', $data, $where);
	}
