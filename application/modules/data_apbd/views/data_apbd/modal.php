    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <?php if (jadwal_input_data_dasar()['aktif']==0) { 

                        $alert_kunci_input = "Swal.fire('Terkunci','Mohon maaf, anda tidak bisa melalukan pengeditan / penginputan. ".jadwal_input_data_dasar()['pesan']."','error')";
                        ?>
                <button type="button" class="btn btn-outline-danger" id="btn_save_anggaran_sub_kegiatan" onclick="<?php echo $alert_kunci_input ?>">Simpan Anggaran</button>

                <?php }else{ ?>
                <button type="button" class="btn btn-primary" id="btn_save_anggaran_sub_kegiatan" onclick="save_anggaran_sub_kegiatan()">Simpan Anggaran</button>
            <?php } ?>
                        ...
                        <table class="table tablr-striped table-bordered" id="table-target" border=1>
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th colspan="4">Keu</th>
                                    <th rowspan="3" colspan="2">Input By</th>
                                </tr>
                                <tr>    
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="kelompok">Pilih Instansi Teknis</label>
                                <div id="form_pilih_instansi_teknis"></div>
                        ...
                        <hr>    
                             <div class="form-group">
                                <label for="anggaran">Daftar Instansi Teknis kegiatan </label>
                                <div id="daftar_instansi_teknis">
        ...
        <div class="modal-content">
                        ...
                        <div class="form-group">
                           ...
                           <!--  <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="id_jenis_sumber_dana" name="id_jenis_sumber_dana">
                                    <?php 
                                    $jenis_sumber_dana = $this->db->get('jenis_sumber_dana')->result_array();
                                    foreach ($jenis_sumber_dana as $k => $v) { ?>
                                       <option value="<?php echo $v['id_jenis_sumber_dana'] ?>"><?php echo $v['jenis_sumber_dana'] ?></option>
                                    <?php } ?>
                                    <option value="Lainnya">Lainnya</option>
                                </select> 
                            </div>
                            <div class="form-group" id="form_nama_sumber_dana" style="display: none">
                            ...
                            <div class="form-group">
                                <label for="lainnya">Nominal Sumber Dana Lainnya</label>
            ...
            <div class="modal-footer">
                    ...
                    <?php if (jadwal_input_data_dasar()['aktif']==0) { 
                        ...
                        $alert_kunci_input = "Swal.fire('Terkunci','Mohon maaf, anda tidak bisa melalukan pengeditan / penginputan. ".jadwal_input_data_dasar()['pesan']."','error')";
                        ?>
                <button type="button" class="btn btn-outline-danger" id="btn_save_anggaran_sub_kegiatan" onclick="<?php echo $alert_kunci_input ?>">Simpan</button>

                <?php }else{ ?>
                <button type="button" class="btn btn-primary" onclick="save_sumber_dana()" id="tombol_simpan_sd">Simpan</button>
            <?php } ?>
