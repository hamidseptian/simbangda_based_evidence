...
function master_instansi_kab_kota()
	{
		...
		$('#table-instansi').DataTable(
		{
	        ...
	        responsive	: true,
	        ajax		: {
				          	url 	: baseUrl('instansi/data_instansi_kab_kota/'),
				            type 	: "POST",
				          	data 	: {}
	        			  },
	        columnDefs  : [
...
function simpan_instansi()
{
	...
	$.ajax({
		url: baseUrl('instansi/simpan_instansi_kab_kota'),
		type: 'POST',
		dataType: 'JSON',
		data: formdata,
...
function edit_instansi_kab_kota(id_instansi)
{
	$.ajax({
		url: baseUrl('instansi/get_instansi_kab_kota/'),
		type: 'POST',
		dataType: 'JSON',
		data: {
...
function simpanedit_instansi()
{
	...
	function hapus_instansi_kab_kota(id_instansi, nama_instansi)
	{
		Swal.fire({
			  title: 'Warning',
			  ...
			  if (result.isConfirmed) {
			  			$.ajax(
						{
							url     : baseUrl('instansi/hapus_instansi_kab_kota/'),
							dataType: 'JSON',
							type    : 'POST',
							data    : { 
								id_instansi : id_instansi
