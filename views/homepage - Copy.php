...
<div class="app-container app-theme-white body-tabs-shadow fixed-header fixed-sidebar">
    ...
    <div class="app-header header-shadow">
        ...
        <div class="app-header__mobile-menu">dddd
            <div>
                                            ...
                                            <div id="carouselExampleControls1" class="carousel slide" data-ride="carousel">
                                                <div class="carousel-inner">
                                                    <div class="carousel-item active">
                                                        <img class="d-block w-100" src="<?php echo base_url() ?>assets/sbe/image/bg1.jpg" alt="First slide">
                                                    ...
                                                    <div class="carousel-item">
                                                        <img class="d-block w-100" src="<?php echo base_url() ?>assets/sbe/image/bg1.jpg" alt="Second slide">
                                                        <div class="carousel-caption d-none d-md-block">
                                                            <h5>Second Slide</h5>
                                                    ...
                                                    <div class="carousel-item">
                                                        <img class="d-block w-100" src="<?php echo base_url() ?>assets/sbe/image/bg1.jpg" alt="Third slide">
                                                        <div class="carousel-caption d-none d-md-block">
                                                            <h5>Third Slide</h5>
